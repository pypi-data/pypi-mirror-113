                ...
                async with db.execute("SELECT guild,member,time FROM tempmute") as cursor:
                    async for entry in cursor:
                        ...
                        try:
                            ...
                            role_add = await db.execute("SELECT role_add FROM mute_role_info WHERE guild = ?", (str(guild.id),))
                            role_add = await role_add.fetchone()
                            role_remove = await db.execute("SELECT role_remove FROM mute_role_info WHERE guild = ?", (str(guild.id),))
