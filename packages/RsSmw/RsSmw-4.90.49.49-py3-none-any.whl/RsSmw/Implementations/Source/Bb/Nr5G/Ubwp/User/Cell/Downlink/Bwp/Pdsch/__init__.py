...
class Pdsch:
	...
	def ag12(self):
		...
		if not hasattr(self, '_ag12'):
			...
			self._ag12 = Ag12(self._core, self._base)
		return self._ag12
	...
	def ap12(self):
		...
		if not hasattr(self, '_ap12'):
			...
			self._ap12 = Ap12(self._core, self._base)
		return self._ap12
	...
	def dc12(self):
		...
		if not hasattr(self, '_dc12'):
			...
			self._dc12 = Dc12(self._core, self._base)
		return self._dc12
	...
	def di12(self):
		...
		if not hasattr(self, '_di12'):
			...
			self._di12 = Di12(self._core, self._base)
		return self._di12
	...
	def ha12(self):
		...
		if not hasattr(self, '_ha12'):
			...
			self._ha12 = Ha12(self._core, self._base)
		return self._ha12
	...
	def maOffset(self):
		...
		if not hasattr(self, '_maOffset'):
			...
			self._maOffset = MaOffset(self._core, self._base)
	...
	def pi11(self):
		...
		if not hasattr(self, '_pi11'):
			...
			self._pi11 = Pi11(self._core, self._base)
		return self._pi11
	...
	def pi12(self):
		...
		if not hasattr(self, '_pi12'):
			...
			self._pi12 = Pi12(self._core, self._base)
		return self._pi12
	...
	def rv12(self):
		...
		if not hasattr(self, '_rv12'):
			...
			self._rv12 = Rv12(self._core, self._base)
		return self._rv12
