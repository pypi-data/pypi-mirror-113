...
all_geometries_path = file_path_base(
    "tests/geoformat_lib/driver/test/all_geometry_type_only.geojson"
)
geometry_only_path = file_path_base(
    "tests/geoformat_lib/driver/test/FRANCE_DPT_GENERALIZE_LAMB93_ROUND_GEOMETRY_ONLY.geojson"
)
geolayer_attributes_only_path = file_path_base(
    "tests/geoformat_lib/driver/test/attributes_only.geojson"
)

geolayer_fr_dept_data_only_geojson_path = file_path_base(
    "tests/geoformat_lib/driver/test/FRANCE_DPT_GENERALIZE_LAMB93_ROUND_DATA_ONLY.geojson"
)

geolayer_fr_dept_data_and_geometry_path = file_path_base(
    "tests/geoformat_lib/driver/test/FRANCE_DPT_GENERALIZE_LAMB93_ROUND.geojson"
)
data_only_path = file_path_base(
    "tests/geoformat_lib/driver/test/dept_population.geojson"
)
