import collections
from typing import Union, Callable, Text
import requests
from requests import Response


# let put a comment here to check if it works 0.0.4
...
class CustomSession(requests.Session):
    ...
    def __init__(self, params=None, data=None, headers=None, cookies=None, files=None,
                 ...
                 prepare: Union[Callable, None] = None, save_last_requests=0):
        self.default_kwargs = {
    ...
    def request(self, method: str, url: Union[str, bytes, Text], **kwargs) -> Response:
