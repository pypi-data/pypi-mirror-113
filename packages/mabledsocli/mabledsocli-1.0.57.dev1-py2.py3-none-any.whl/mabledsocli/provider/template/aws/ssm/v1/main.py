...
class AwsSsmTemplateProvider(TemplateProvider):
    ...
    def add(self, project, application, stage, key, contents, render_path=None):
        ...
        response = self.ssm.put_parameter(Name=path, Value=escape_curly_brackets(contents), Type='StringList', Overwrite=True)
        return {
                'Key': key,
    ...
    def get(self, project, application, stage, key, revision=None):
        ...
        response = self.ssm.get_parameter_history(Name=found['Name'])
    ...
    def delete(self, project, application, stage, key):
        ...
        response = self.ssm.delete_parameter(Name=found['Name'])
        return {
                'Key': key, 
                'Scope': found['Scope'],
                'Origin': found['Origin'],
