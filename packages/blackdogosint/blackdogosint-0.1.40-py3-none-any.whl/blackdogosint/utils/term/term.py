...
from blackdogosint.utils.context import ContextType
...
def update_geometry():
    ...
    # everything down
    if h < height and scroll == 0 and cells and cells[-1].end[0] < 0:
...
def output(
    s='', float=False, priority=10, frozen=False,
