...
class Pattern:
	...
	def set(self, structure: PatternStruct, userEquipment=repcap.UserEquipment.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.uplink.ue.cell.pusch.pattern.set(value = [PROPERTY_STRUCT_NAME](), userEquipment = repcap.UserEquipment.Default, cellNull = repcap.CellNull.Default) \n
