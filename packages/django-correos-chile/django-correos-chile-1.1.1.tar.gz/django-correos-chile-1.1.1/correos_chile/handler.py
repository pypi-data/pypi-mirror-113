...
class CorreosHandler:
    ...
    def get_default_payload(self, data):
        ...
        payload = {
            'reference': data.wms_reference,
            'recipient_name': data.customer_full_name,
            'recipient_address': f'{address.street} {address.number}',
            'recipient_postal_code': address.commune.code,
            'recipient_commune': address.commune.name,
            'recipient_rut': data.customer_rut,
            'recipient_contact': data.customer_full_name,
