...
class Meteorologia(BaseProduto):
    ...
    def comparar(self, body_comparador: BodyComprarador) -> dict:
        """
        Compara dois modelos com base nos parâmetros informados no objeto BodyComprarador.


        :param body_comparador: Corpo da requisição com as informações de comparação.
        :type body_comparador: BodyComprarador
        :return: dict
        """
        try:
            p_key = self.request.request_prod_key(Produto.METEOROLOGIA.value)
