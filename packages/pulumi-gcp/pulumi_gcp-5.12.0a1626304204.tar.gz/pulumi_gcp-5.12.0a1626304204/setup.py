...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.12.0-alpha.1626304204+88e59fe9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.12.0-alpha.1626304204+88e59fe9`
                """)
            else:
                raise
