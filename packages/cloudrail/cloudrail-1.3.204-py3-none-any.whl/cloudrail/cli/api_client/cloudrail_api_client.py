...
class CloudrailApiClient(ExternalApiClient):
    ...
    AWS_SUPPORTED_SERVICES: str = '/supported_services/aws?iac_type={0}'
    AZURE_SUPPORTED_SERVICES: str = '/supported_services/azure'
    GCP_SUPPORTED_SERVICES: str = '/supported_services/gcp'
    ...
    SSO_METADATA_PATH: str = '/settings/sso/metadata'
