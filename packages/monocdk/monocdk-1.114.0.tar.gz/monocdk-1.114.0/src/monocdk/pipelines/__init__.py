...
class GitHubSourceOptions:
    ...
    def authentication(self) -> typing.Optional[_SecretValue_c18506ef]:
        ...
        It is recommended to use a Secrets Manager ``Secret`` to obtain the token::
           ...
           GitHubSource(self, "GitHubSource", oauth_token=oauth, ...)
...
class ProduceActionOptions:
    ...
    def pipeline(self) -> PipelineBase:
        ...
        return typing.cast(PipelineBase, result)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"trigger": "trigger"},
)
class S3SourceOptions:
    def __init__(self, *, trigger: typing.Optional[_S3Trigger_688e3a4a] = None) -> None:
...
class CodePipelineSource(
    ...
    def s3(
        ...
        *,
        ...
        :stability: experimental
        '''
        props = S3SourceOptions(trigger=trigger)
...
class CodeBuildStep(
    ...
    @jsii.member(jsii_name="project")
    def project(self) -> _IProject_6da8803e:
        '''(experimental) CodeBiuld Project generated for the pipeline.
