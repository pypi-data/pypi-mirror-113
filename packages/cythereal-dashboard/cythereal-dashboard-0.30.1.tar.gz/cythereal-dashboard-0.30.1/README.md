...
*FilesApi* | [**list_av_data**](docs/FilesApi.md#list_av_data) | **GET** /files/avdata/ | Takes a list of hashes and returns a list of their avdata
*FilesApi* | [**list_binary_data**](docs/FilesApi.md#list_binary_data) | **GET** /files/binarydata/ | Takes a list of hashes and returns a list of their match and label data
*FilesApi* | [**list_file_info**](docs/FilesApi.md#list_file_info) | **GET** /files/fileinfo/ | Takes a list of hashes and returns a list of their info
