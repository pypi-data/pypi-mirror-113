...
def remove_from_group(self, participant_name: str):
    ...
    try:
        ...
        self.driver.find_element_by_css_selector(
            "#app > div._3h3LX._34ybp.app-wrapper-web.font-fix.os-win > div._3QfZd.three > div.Akuo4 > div._1Flk2._3xysY > span > div._1sMV6 > span > div.OMoBQ._2W4mF._3wXwX.copyable-area > div > section > div:nth-child(5) > div.-ZdaK > div > div > div._3TVPy > span"
        ).click()
        ...
        # try:
        #    self.driver.find_element_by_css_selector(
        #        "#app > div._3h3LX._34ybp.app-wrapper-web.font-fix.os-win > span:nth-child(2) > div._1XTIr > div > div > div > div > div > #div > div._1C2Q3._36Jt6 > div:nth-child(1) > div > div > div > div > div > div.TbtXF > div._2pkLM > div._15smv > div"
        #    )
        #
        #    self.driver.find_element_by_css_selector(
        #        "#app > div._3h3LX._34ybp.app-wrapper-web.font-fix.os-win > span:nth-child(4) > div > ul > div > li:nth-child(2)"
        #    ).click()
        #
        # except:
        self.driver.find_element_by_css_selector(
            "#app > div._3h3LX._34ybp.app-wrapper-web.font-fix.os-win > span:nth-child(4) > div > ul > div > li:nth-child(1)"
        ).click()
