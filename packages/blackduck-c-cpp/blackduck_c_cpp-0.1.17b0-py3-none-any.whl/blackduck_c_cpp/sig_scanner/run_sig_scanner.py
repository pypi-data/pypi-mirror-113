...
class SigScanner:
    ...
    def __init__(self, cov_base_path, hub_api, files_notdetect_from_pkgmgr, project_name, project_version_name,
                 code_location_name, cov_emit_output_sig, cov_output, sig_scanner_path, offline_mode,
        ...
        self.sig_scan_output_directory = os.path.join(cov_output, 'sig_scan')
        ...
        if self.offline_mode:
            if self.scan_cli_dir != '':
                ...
                try:
                    ...
                    logging.error("scan cli not found at location: {}".format(self.scan_cli_directory))
                    return
        else:
    ...
    def run_sig_scanner(self):
        ...
        util.run_cmd(sig_scanner_command, env=env)
