...
class ProblemService:
    ...
    def load_themis_testcases(problem_folder, problem: Problem):
        problem.testcases = TestcaseService.load_testcases(problem_folder, format='themis')

    @staticmethod
    def load_cms_testcases(problem_folder, problem: Problem):
        problem.testcases = TestcaseService.load_testcases(os.path.join(problem_folder, "testcases.zip"), format='cms')
