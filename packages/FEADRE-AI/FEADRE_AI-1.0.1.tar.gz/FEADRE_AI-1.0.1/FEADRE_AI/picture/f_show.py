...
def _draw_box4plt(boxes, texts=None, font_size=10, color='red', ax=None, recover_sizewh=None):
    '''
...
def f_show_od_np4plt_v3(img_np, g_ltrb=None, p_ltrb=None, other_ltrb=None,
                        is_recover_size=False, g_texts=None):
    ...
    if g_ltrb is not None:
        _draw_box4plt(g_ltrb, texts=g_texts, color='lightgreen', ax=ax, recover_sizewh=recover_sizewh)
