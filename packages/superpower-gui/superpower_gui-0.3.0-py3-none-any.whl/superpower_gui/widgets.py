...
__all__ = ['logger', 'CallbackDispatcher', 'Widget', 'Output', 'IntSlider', 'FloatSlider', 'IntProgress',
           ...
           'GridBox', 'Layout', 'AlignedLabel', 'IntLabel', 'Grid']
...
# Cell
class AlignedLabel(Widget, ipyw.Box):

    value = Unicode()

    def __init__(self, value=None, alignment='center', justification='center', **kwargs):
        super().__init__(**kwargs)
        if value:
            self.value = value
        self.layout.align_items = alignment
        self.layout.justify_content = justification
