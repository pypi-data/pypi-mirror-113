...
class DataServicesResource(object):
    ...
    # from .another_hello_world import AnotherHelloWorld
    from .modules.another_hello_world import AnotherHelloWorld
    ...
    def anotherHelloWorld(self):
        return self.AnotherHelloWorld(self)
