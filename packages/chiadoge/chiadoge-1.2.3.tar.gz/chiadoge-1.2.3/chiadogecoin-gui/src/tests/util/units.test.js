...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of chiadoge', () => {
      const result = units.getUnit('chiadoge');
    ...
    it('gets unit of chiadoge using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of chiadoge', () => {
      const result = units.getDisplay('chiadoge');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('chiadoge', 9);

      const result = units.getUnit('chiadoge');

      expect(result).toEqual(9);

      units.setUnit('chiadoge', 1);
    });
  });
  describe('#setDisplay', () => {
