...
NAME = "tuneflow"
MAIN_PACKAGE = "tuneflow"
DESCRIPTION = "A simple way to fine-tune your models and datasets."
URL = "https://github.com/lukasmasuch/tuneflow"
...
setup(
    ...
    zip_safe=False,
    install_requires=["streamlit>=0.84.0", "pydantic", "streamlit-pydantic"],
