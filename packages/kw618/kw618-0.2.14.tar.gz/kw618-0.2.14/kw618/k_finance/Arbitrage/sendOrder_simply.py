...
class LuckinUtils():
    ...
    def filter_lot_size(self, symbol, base_qty):
        ...
        filtered_base_asset = math.floor(round(base_qty / base_asset_precision, 10)) * base_asset_precision
        filtered_base_asset = round(filtered_base_asset, 10) # 上面的计算中可能出现'python浮点精度问题', 所以这里必须再做一次round
        return filtered_base_asset
