...
class ConfigUtil:
    ...
    def __merge_configs(self, subliminal, superliminal, is_render_variables):
        ...
        sub[self.__IMAGES] = self.__merge_images(sub, merged_superliminal)
    ...
    def __merge_images(self, subliminal, superliminal):
        return self.__deep_list_keyword_merge('image', subliminal.get(self.__IMAGES, []),
                                              superliminal.get(self.__IMAGES, []))
