...
datasets = pd.read_parquet(f'sarima_AR5_monthly.parquet')
...
pd.concat(features_array).to_parquet('features3.parquet')
pd.concat(performance_array).to_parquet('performance3.parquet')
pd.DataFrame(errors_array).to_parquet('errors3.parquet')
