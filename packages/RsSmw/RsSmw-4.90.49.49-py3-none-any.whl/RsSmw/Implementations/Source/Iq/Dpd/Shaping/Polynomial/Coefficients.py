...
class Coefficients:
	...
	def get_value(self) -> ValueStruct:
		...
		Snippet: value: ValueStruct = driver.source.iq.dpd.shaping.polynomial.coefficients.get_value() \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:IQ:DPD:SHAPing:POLYnomial:COEFficients?', self.__class__.ValueStruct())

	def set_value(self, value: ValueStruct) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:POLYnomial:COEFficients \n
		Snippet: driver.source.iq.dpd.shaping.polynomial.coefficients.set_value(value = ValueStruct()) \n
		Sets the polynomial coefficients as a list of up to 10 comma separated value pairs. In Cartesian coordinates system, the
		coefficients bn are expressed in degrees. \n
			:param value: see the help for ValueStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:IQ:DPD:SHAPing:POLYnomial:COEFficients', value)
