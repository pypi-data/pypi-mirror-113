...
class AscendModel():
    ...
    def get_tensor_by_name(self, out_node_name:str):
        ...
        Args:
            out_node_name.
            use likes: 
                output_tensor1 = get_tensor_by_name('output_tensor_name1')
                output_tensor2 = get_tensor_by_name('output_tensor_name2')
    ...
    def set_batch(self, tensor_name, batch):
        ...
        idx, ret = acl.mdl.get_input_index_by_name(self.__model_desc.desc, name)
        if ret != ACL_SUCCESS:
