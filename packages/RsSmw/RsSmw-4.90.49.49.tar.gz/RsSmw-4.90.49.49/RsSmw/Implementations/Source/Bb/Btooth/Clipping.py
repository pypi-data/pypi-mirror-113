...
class Clipping:
	...
	def get_state(self) -> bool:
		...
		The command activates level clipping (Clipping) . The value is defined with the command method RsSmw.Source.Bb.Btooth.
		Clipping.level, the mode of calculation with the command method RsSmw.Source.Bb.Btooth.Clipping.mode. \n
