...
from FastCNN.file.files import CsvFile
...
class MACallBack2(Callback):
    ...
    def init(self,projectname,modeltag,model):
        ...
        path = getTrainProcessValues(projectname,modeltag)
    ...
    def on_epoch_end(self,epoch, logs=None):
        ...
        if model_tag:
            ...
            if train_mean > max_train_acc:
                ...
                MACallBack2.saveModelEpoch(trainmodelpath,epoch)
            ...
            if valid_mean > max_valid_acc:
                ...
                MACallBack2.saveModelEpoch(validmodelpath,epoch)
