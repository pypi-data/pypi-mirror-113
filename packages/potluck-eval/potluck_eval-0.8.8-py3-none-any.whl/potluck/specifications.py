    ...
    def test_output(self, capture_errors=False):
        ...
        if hasattr(self, "fn_name"):
            if self.fn_name == "__import__":
                ...
                self.context_args["description"] = (
                    "The output printed by your program",
                    (
                        "We will run your program and capture what it"
                        " prints."
                    ),
                    "The output printed by your program",
                    "We ran your program and recorded what it printed."
                )
            else:
                self.default_goal_args["description"] = (
                ...
                args_desc = (
                  ...
                  + self.args_repr
                ) if hasattr(self, "args_repr") else ""
                self.context_args["description"] = (
                    f"The output printed by <code>{self.fn_name}</code>",
                    (
                        f"We will run your <code>{self.fn_name}</code>"
                        f" function and capture what it prints."
                    ),
                    f"The output printed by <code>{self.fn_name}</code>",
                    (
                        f"We ran your <code>{self.fn_name}</code>"
                        f" function and recorded what it printed."
                        f"{args_desc}"
                    ),
                )
        else:
            ...
            self.context_args["description"] = (
                "The output printed by your code",
                "We will run your code and capture what it prints."
                "The output printed by your code",
                "We ran your code and recorded what it printed."
            )
                ...
                default_context_args={
                    ...
                    "description": (
                        ...
                        (
                            ...
                            f" function and capture the return value."
                        ),
                        f"The result of <code>{fn_name}</code>",
                        (
                            f"We ran your <code>{fn_name}</code>"
                          + " function and recorded the return value."
                          + " We ran your function with the following"
                          + " arguments:"
                          + self.args_repr
                        ),
                    ),
