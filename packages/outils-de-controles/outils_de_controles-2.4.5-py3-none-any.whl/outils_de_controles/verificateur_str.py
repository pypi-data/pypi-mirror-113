...
class VerificateurStr(Verificateur) :
    ...
    def __str__(self) :
        ...
        return """◄minimum:{obj._minimum}, maximum:{obj._maximum}, regex:'{obj._regex}'►""".format(obj = self)#obj désigne l'objet vérificateur qu'il faut afficher
    ...
    def __repr__(self) :
        ...
        """
        chaine = """outils_de_controles.VerificateurStr(minimum={}, maximum={}, regex={})""".format(repr(self._minimum), repr(self._maximum), repr(self._regex))
        return chaine
    ...
    def __eq__(self, autre_objet) :
        ...
        retour = False
        if self.types == autre_objet.types and self.minimum == autre_objet.minimum and self.maximum == autre_objet.maximum and self._regex == autre_objet.regex :
            retour = True
        return retour
    ...
    def controle_regex(self, objet_controle) :
        ...
        """
        if re.search(self._regex, objet_controle) is None :
            raise ValueError("La chaine objet_controle passée en paramètre ne correspond pas à {}.".format(self._regex))
