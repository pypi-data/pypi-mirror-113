...
from ._type_utils import BASE_SCENARIO, ScenarioName, is_temporal
...
class JavaApi(metaclass=ApiMetaClass):
    ...
    def publish_measures(self, cube_name: str):
        ...
        self.java_api.publishMeasures(cube_name)
    ...
    def create_table(
        ...
        *,
        ...
        self.java_api.createStore(name, table_params)
    ...
    def create_table_from_source(
        ...
        *,
        ...
        self.java_api.createStoreFromDataSource(
            table_name, source_key, table_params, load_params, source_params
        )
    ...
    def get_table_partitioning(self, table: Table) -> str:
        ...
        return self.java_api.getStorePartitioning(table.name)
    ...
    def get_key_columns(self, table: Table) -> Sequence[str]:
        ...
        java_columns = self.java_api.getKeyFields(table.name)
    ...
    def create_cube_from_table(
        ...
        *,
        ...
        self.java_api.createCubeFromStore(table.name, cube_name, creation_mode)
    ...
    def create_join(
        ...
        *,
        ...
        self.java_api.createReferences(table.name, other_table.name, jmappings)

    def get_table_size(self, table: Table) -> int:
        """Get the size of the table on its current scenario."""
        return self.java_api.getStoreSize(table.name, table.scenario)
    ...
    def get_table_dataframe(
        ...
        *,
        ...
        dfrh = self.java_api.dataFrameRowsAndHeaders(table.name, scenario_name, rows)
    ...
    def create_measure(  # pylint: disable=too-many-positional-arguments
        self,
        cube: Cube,
    ...
    def array_element_at(
        ...
        *,
        cube_name: str,
        measure_name: Optional[str],
        array_measure: MeasureDescription,
        index_measure: MeasureDescription,
        ...
        jlevels = to_java_string_array(levels, gateway=self.gateway)
    ...
    def create_parameter_simulation(
        ...
        *,
        ...
        return self.java_api.createParameterSimulation(
            cube.name,
            simulation_name,
            jlevels,
            base_scenario_name,
    ...
    def should_warn_for_table_sampling_policy(self, table: Table) -> bool:
        """Check whether we should warn because a table does not respect the policy."""
        return self.java_api.shouldWarnForSamplingPolicy(table.name)
