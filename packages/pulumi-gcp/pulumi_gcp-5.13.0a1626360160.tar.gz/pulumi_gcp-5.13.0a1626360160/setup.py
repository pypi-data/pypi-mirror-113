...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.13.0-alpha.1626360160+b90b7beb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.13.0-alpha.1626360160+b90b7beb`
                """)
            else:
                raise
