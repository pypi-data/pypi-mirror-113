...
from codec_Watteco.TICs import *
...
_XYZAccParamsStruct_ = Struct(
	...
	Embedded("WorkingModes" / BitStruct(
		"SignalEachAcq" / Enum(Bit, Yes = 1 , No = 0),
		"Reserved" / BitsInteger(4),
		"RstAftStdRpt_X" / Enum(Bit, Yes = 1 , No = 0),
		"RstAftStdRpt_Y" / Enum(Bit, Yes = 1 , No = 0),
		"RstAftStdRpt_Z" / Enum(Bit, Yes = 1 , No = 0)
	))
)
...
TICCFGReportData = Struct(
	...
	"TICCriteriaFields" / _TICData_
)
 
TICData = Struct(
	"TICDataSelector" / TICFieldsSelector,
	"TICDataFields"   / _TICData_
)
