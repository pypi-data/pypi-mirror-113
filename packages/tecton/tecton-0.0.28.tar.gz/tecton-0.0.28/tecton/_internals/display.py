...
from tecton._internals.workspace_utils import server_to_client_name
...
def _default_value_formatter(key, value):
...
def _fco_metadata_formatter(key, value):
    if key == "workspace":
        return server_to_client_name(value)
    return _default_value_formatter(key, value)
...
class Displayable(object):
    ...
    def from_fco_summary(
        ...
        additional_items=[],
        value_formatter: Callable[[str, Any], str] = _default_value_formatter,
    ):
