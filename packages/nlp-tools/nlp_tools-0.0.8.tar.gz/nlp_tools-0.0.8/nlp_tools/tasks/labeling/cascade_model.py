...
class Cascade_Model(ABCLabelingModel):
    ...
    def build_model_arc(self) -> None:
        ...
        logits_label = L.Dense(label_output_dim, **config['layer_time_distributed'])(tf.concat([tensor,predict_label_embedding],axis=-1))
    ...
    def compile_model(self,
        ...
        if metrics is None:
            metrics = [[self.crf_layer.fast_accuracy],[sparse_categorical_accuracy]]
