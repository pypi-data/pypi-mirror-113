...
class AbstractGrapheneMutationCreator(abc.ABC):
    ...
    def _perform_authentication(self, mutation_instance, info, *args, **kwargs) -> any:
        ...
        request.are_we_authenticating_from_login_mutation = True # We are trying to authenticate via a login mutation
        user = authenticate(root=mutation_instance, info=info, *args, **kwargs) # Call django to authenticate the user
        if user is None:
    ...
    def login_mutation_body(self, mutation_instance, info, *args, **kwargs) -> any:
        """
