...
def ppxf_example_population_gas_sdss(tie_balmer, limit_doublets):
    ...
    # is the proper one related to redshift via eq.(8) of Cappellari (2017).
    c = 299792.458
    ...
    light_weights /= light_weights.sum()            # Normalize

    # Give that the templates are normalized to the V-band, the pPXF weights
    ...
    mass_weights /= mass_weights.sum()              # Normalize
