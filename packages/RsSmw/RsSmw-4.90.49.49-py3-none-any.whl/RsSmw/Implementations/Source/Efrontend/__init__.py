...
class Efrontend:
	...
	def cal(self):
		...
		if not hasattr(self, '_cal'):
			from .Cal import Cal
			self._cal = Cal(self._core, self._base)
		return self._cal
	...
	def concurrent(self):
		...
		if not hasattr(self, '_concurrent'):
			...
			self._concurrent = Concurrent(self._core, self._base)
	...
	def selftest(self):
		...
		if not hasattr(self, '_selftest'):
			...
			self._selftest = Selftest(self._core, self._base)
	...
	def trxMode(self):
		...
		if not hasattr(self, '_trxMode'):
			...
			self._trxMode = TrxMode(self._core, self._base)
