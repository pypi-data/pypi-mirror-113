...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.11.0-alpha.1626360184+ae89f919'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.11.0-alpha.1626360184+ae89f919`
                """)
            else:
                raise
