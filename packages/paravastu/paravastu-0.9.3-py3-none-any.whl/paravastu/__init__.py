...
def RetreivePDBatomPosition(PDBDataFrame, segmentIDstring, residueNumber, atomNameString):
    df1 = PDBDataFrame.loc[PDBDataFrame["segment_id"]== segmentIDstring]
    df1= df1.loc[PDBDataFrame["residue_number"]==residueNumber]
    df1 = df1.loc[PDBDataFrame["atom_name"]==atomNameString]
