"""
Package to create a Area Chart. To make a simple area chart, go to https://sid72020123.github.io/pyhtmlchart/#making-area-chart
"""
import os
import time
...
class AreaChart:
    def __init__(self, location, title='Chart', background_color='White', legend_position='right', width=900,
                 ...
                 y_axis_title='Y', x_axis_title='X', color=None, print_log=False):
        """
        Class to make a Area Chart!
    ...
    def add_data(self, data, data_titles):
        ...
        file.write(
            f"</script>\n</head>\n<body>\n<div id = 'area_chart' style = 'width: {self.width}px; height: {self.height}px'></div>\n</body>\n</html>")
        file.close()
        if self.print_log:
