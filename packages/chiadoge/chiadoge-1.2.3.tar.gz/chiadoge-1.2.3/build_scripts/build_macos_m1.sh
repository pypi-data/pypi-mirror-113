...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Chia-darwin-arm64/chiadoge.app --platform=darwin \
...
DMG_NAME="Chiadoge-$CHIADOGE_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Chia-darwin-arm64/chiadoge.app Chiadoge-$CHIADOGE_INSTALLER_VERSION-arm64 \
