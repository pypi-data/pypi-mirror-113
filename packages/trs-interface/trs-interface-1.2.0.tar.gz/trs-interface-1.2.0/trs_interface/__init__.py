...
.. code-block:: python
    ...
    trsi.delay_trigin_polarity = Polarity.LOW
...
class TRSInterface():
    ...
    def __init__(self, serial_port=None, location=""):
        ...
        if serial_port is None:
            raise RuntimeError(f"No TRSInterface devices detected with location matching '{location}'.")
    ...
    def start(self):
        ...
        self._update_handle.cancel()
        self._loop.call_soon_threadsafe(self._write, encoder.start())
