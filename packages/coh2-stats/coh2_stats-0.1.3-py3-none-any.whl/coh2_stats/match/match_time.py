...
class MatchTime:
    ...
    def in_range_date(self, start: tuple = (1, 1), end: tuple = (12, 31)):
        start_date = datetime.datetime(2021, start[0], start[1], 0, 0)
        end_date   = datetime.datetime(2021, end[0],   end[1], 23, 59)
