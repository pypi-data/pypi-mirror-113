...
### Trying out the APIs
This microservice has preliminary Swagger3/OpenAPI support so that you can quickly test the APIs in a web browser. Do
the following:
* Install Docker, if it is not installed already.
* Run the `test_openapi3.py` file in your terminal.
* Go to the "Running on ..." URL listed in the output in your web browser.
