...
NAME = "streamlit-huggingface"
MAIN_PACKAGE = "streamlit_huggingface"
DESCRIPTION = "Streamlit components to build interactive Huggingface-powered apps."
URL = "https://github.com/lukasmasuch/streamlit-huggingface"
