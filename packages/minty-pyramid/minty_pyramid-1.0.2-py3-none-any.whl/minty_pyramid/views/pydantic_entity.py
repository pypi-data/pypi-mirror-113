...
class JSONAPIEntityView:
    ...
    def transform_response_from_entity(self, entity_type, entity_id):
    ...
    def transform_response_from_command(self, calldata, params):
        ...
        try:
            if (
                ...
                try:
                    entity_type = params[calldata["entity_type"]]
                except KeyError:
