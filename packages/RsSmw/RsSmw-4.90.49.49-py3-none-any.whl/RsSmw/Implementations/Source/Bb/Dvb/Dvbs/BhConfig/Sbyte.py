...
class Sbyte:
	...
	def get_pattern(self) -> PatternStruct:
		...
		Snippet: value: PatternStruct = driver.source.bb.dvb.dvbs.bhConfig.sbyte.get_pattern() \n
		Sets the user packet synchronization byte. \n
			:return: structure: for return value, see the help for PatternStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:DVB:DVBS:BHConfig:SBYTe:PATTern?', self.__class__.PatternStruct())

	def set_pattern(self, value: PatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBS:BHConfig:SBYTe:PATTern \n
		Snippet: driver.source.bb.dvb.dvbs.bhConfig.sbyte.set_pattern(value = PatternStruct()) \n
		Sets the user packet synchronization byte. \n
			:param value: see the help for PatternStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:DVB:DVBS:BHConfig:SBYTe:PATTern', value)
