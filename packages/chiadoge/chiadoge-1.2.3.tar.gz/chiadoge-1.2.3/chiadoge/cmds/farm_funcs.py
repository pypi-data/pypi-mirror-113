...
from chiadoge.util.misc import format_bytes
from chiadoge.util.misc import format_minutes
from chiadoge.util.network import is_localhost
...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'chiadoge start wallet' and 'chiadoge wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'chiadoge wallet show'")
    else:
