...
class Rtfb:
	...
	def get_rv_sequence(self) -> str:
		...
		sequence is used again even in case a NACK is received, if the maximum number of transmissions (method RsSmw.Source.Bb.
		Eutra.Uplink.Rtfb.maxTrans) in a process was reached. \n
