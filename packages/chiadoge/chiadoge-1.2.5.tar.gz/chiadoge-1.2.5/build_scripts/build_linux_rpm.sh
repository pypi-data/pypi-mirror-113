...
if [ ! "$1" ]; then
  echo "This script requires either amd64 of arm64 as an argument"
	...
	DIR_NAME="chiadoge-linux-x64"
else
	#PLATFORM="$1"
	DIR_NAME="chiadoge-linux-arm64"
fi
...
electron-packager . chiadoge --asar.unpack="**/daemon/**" --platform=linux \
...
if [ "$REDHAT_PLATFORM" = "x86_64" ]; then
	echo "Create chiadogecoin-$CHIADOGE_INSTALLER_VERSION.rpm"
