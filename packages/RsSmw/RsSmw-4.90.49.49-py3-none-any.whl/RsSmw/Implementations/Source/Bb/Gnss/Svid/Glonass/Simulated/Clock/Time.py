...
class Time:
	...
	def set(self, structure: TimeStruct, satelliteSvid=repcap.SatelliteSvid.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.glonass.simulated.clock.time.set(value = [PROPERTY_STRUCT_NAME](), satelliteSvid = repcap.SatelliteSvid.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:GNSS:SVID{satelliteSvid_cmd_val}:GLONass:SIMulated:CLOCk:TIME', structure)
