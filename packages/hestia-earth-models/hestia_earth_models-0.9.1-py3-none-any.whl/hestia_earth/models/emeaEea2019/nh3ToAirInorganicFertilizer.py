...
def _should_run(cycle: dict):
    ...
    soilPh = list_average(most_relevant_measurement_value(measurements, 'soilPh', end_date))
    temperature = most_relevant_measurement_value(measurements, 'temperatureAnnual', end_date)
    temperature = list_average(
        most_relevant_measurement_value(
    ...
    debugRequirements(model=MODEL, term=TERM_ID,
                      ...
                      soilPh=soilPh,
                      unspecifiedAsN=len(unspecifiedAsN),
    ...
    return should_run, temperature, soilPh, N_inputs, unspecifiedAsN, country_id
