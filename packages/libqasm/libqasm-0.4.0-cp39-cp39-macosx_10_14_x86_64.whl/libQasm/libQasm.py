...
class V1Analyzer(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _libQasm.V1Analyzer_swiginit(self, _libQasm.new_V1Analyzer(*args))

    def register_instruction(self, *args):
        return _libQasm.V1Analyzer_register_instruction(self, *args)

    def register_error_model(self, *args):
        return _libQasm.V1Analyzer_register_error_model(self, *args)

    @staticmethod
    def parse_file(filename):
        return _libQasm.V1Analyzer_parse_file(filename)

    @staticmethod
    def parse_string(*args):
        return _libQasm.V1Analyzer_parse_string(*args)

    def analyze_file(self, filename):
        return _libQasm.V1Analyzer_analyze_file(self, filename)

    def analyze_string(self, *args):
        return _libQasm.V1Analyzer_analyze_string(self, *args)
    __swig_destroy__ = _libQasm.delete_V1Analyzer

# Register V1Analyzer in _libQasm:
_libQasm.V1Analyzer_swigregister(V1Analyzer)

def V1Analyzer_parse_file(filename):
    return _libQasm.V1Analyzer_parse_file(filename)

def V1Analyzer_parse_string(*args):
    return _libQasm.V1Analyzer_parse_string(*args)
