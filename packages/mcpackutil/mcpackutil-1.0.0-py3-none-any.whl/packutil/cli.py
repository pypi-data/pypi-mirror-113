...
def extract(ctx, v, o, i):
    ...
    if v is None or o is None:
        sys.exit("Please provide a valid Minecraft version and output version")
...
def handle_error(ctx):
    ...
    if ctx.obj["v"] is None:
        error += "a Minecraft version "

    if ctx.obj["o"] is None:
        error += "an Output path "
