...
@_decoder(ID.GET_DELAY_TRIGIN_POLARITY)  # id=0x1030
def get_delay_trigin_polarity(data_raw: bytes) -> Dict[str, Any]:
    return {}

@_decoder(ID.GOT_DELAY_TRIGIN_POLARITY)  # id=0x1031
def got_delay_trigin_polarity(data_raw: bytes) -> Dict[str, Any]:
    return {}

@_decoder(ID.SET_DELAY_TRIGIN_POLARITY)  # id=0x1032
def set_delay_trigin_polarity(data_raw: bytes) -> Dict[str, Any]:
    return {}
