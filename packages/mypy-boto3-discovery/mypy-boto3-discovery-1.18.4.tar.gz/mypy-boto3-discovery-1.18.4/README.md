...
[boto3.ApplicationDiscoveryService 1.18.4](https://boto3.amazonaws.com/v1/documentation/api/1.18.4/reference/services/discovery.html#ApplicationDiscoveryService)
