...
setup(name='pybluez22',
      version='1.0',
      description='Bluetooth Python extension module based on Pybluez 0.22',
      author="salman rahman",
      author_email="salman2135@gmail.com",
      url="https://github.com/salman2135/pybluez22",
