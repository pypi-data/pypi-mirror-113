...
import threading
import wda
from rctaitest.core.error import rctaitestError
from rctaitest.utils.snippet import reg_cleanup, make_file_executable, get_std_encoding
from rctaitest.utils.logger import get_logger
from rctaitest.utils.retry import retries
from rctaitest.utils.compat import SUBPROCESS_FLAG
from rctaitest.core.ios.constant import DEFAULT_IPROXY_PATH
from rctaitest.core.ios.relay import ThreadedTCPServer, TCPRelay
...
class InstructHelper(object):
    ...
    def do_proxy(self, local_port, device_port):
        ...
        if not self.usb_device:
            raise rctaitestError("Currently only supports port forwarding for locally connected iOS devices")
        ...
        if proc.poll() is not None:
            ...
            raise rctaitestError((stdout, stderr))
