...
class ResponseWorkspaceList(object):
    ...
    def __init__(self, created_by=None, created_dt=None, endpoints=None, histories=None, id=None, kernel_cluster=None, kernel_resource_spec=None, name=None, status=None, status_last_updated=None, status_reason=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
