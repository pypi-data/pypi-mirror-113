    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.5.0 fwBuild=21/07/2021-14:08:24 fwHash=0xB6DFB466 fwDirty=0 kmodVersion=0.5.0 kmodBuild=21/07/2021-14:08:24 kmodHash=0xB6DFB466 kmodDirty=0 swVersion=0.5.0 swBuild=21/07/2021-14:08:24 swHash=0xB6DFB466 swDirty=0"
                if build != build_ref:
