...
class EmFuturePriceDetail(Base):
    ...
    VOLUME =  Column('volume', Integer) # 成交量
    AMOUNT = Column('amount', DOUBLE(asdecimal=False)) # 成交金额      
    ...
    HQOI = Column('hq_oi', DOUBLE(asdecimal=False)) # 持仓量
    CHANGEOI = Column('change_oi', DOUBLE(asdecimal=False)) # 持仓量变化 
