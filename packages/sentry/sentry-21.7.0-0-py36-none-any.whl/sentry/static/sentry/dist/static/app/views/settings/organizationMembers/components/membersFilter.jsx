...
var MembersFilter = function (_a) {
    ...
    var handleRoleFilter = function (id) { return function () {
        var roleList = new Set(search.getTagValues('role') ? tslib_1.__spreadArray([], tslib_1.__read(search.getTagValues('role'))) : []);
        if (roleList.has(id)) {
            roleList.delete(id);
        }
        else {
        ...
        newSearch.setTagValues('role', tslib_1.__spreadArray([], tslib_1.__read(roleList)));
