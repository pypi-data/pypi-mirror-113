...
class Decimal:
	...
	def set(self, structure: DecimalStruct, vdbTransmitter=repcap.VdbTransmitter.Default) -> None:
		...
		Snippet: driver.source.bb.gbas.vdb.mconfig.lfLocation.coordinates.decimal.set(value = [PROPERTY_STRUCT_NAME](), vdbTransmitter = repcap.VdbTransmitter.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:GBAS:VDB{vdbTransmitter_cmd_val}:MCONfig:LFLocation:COORdinates:DECimal', structure)
