...
if "READTHEDOCS" not in os.environ:
    ...
    from gospl._fortran import distland
...
class SEDMesh(object):
    ...
    def distributeOcean(self, hclino, sinkFlx):
    ...
    def diffuseOcean(self, ndepo, stype):
    ...
    def distributeSediment(self, stype=0):
        ...
        # t0 = process_time()
        # ndepo = self.distributeOcean(hclino, sinkFlx)
        # if MPIrank == 0 and self.verbose:
        #     print(
