        ...
        for (size_t n=0;n<numberOfConnections;n++) {
            ...
            for (size_t i=0;i<nbOfElement;i++) {
                ...
                if (fabs(diffusedAtoms)>NUMERICLIMITDOUBLE)                {
                    ...
                    //if (dt>=coeffCFLcondition*distanceNodes*distanceNodes/2/D) { //CAUTION: ONLY VALID FOR LAYERS !!!
                    if (((diffusedAtoms>0)&&(C1*V1+diffusedAtoms>C0*V0))||((diffusedAtoms<0)&&(C0*V0-diffusedAtoms>C1*V1))) {
