...
from worker.utils import get_working_dir, is_windows
...
class NjinnWorker:
    def __init__(
        self, registration_token=None, njinn_url=None, no_default_queues=False
    ):
        # Obtain working dir from $NJINN_WORKER_WORKINGDIR, else fallback to worker dir as working dir
