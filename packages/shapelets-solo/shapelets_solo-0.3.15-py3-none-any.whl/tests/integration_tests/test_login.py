...
class LoginTest(unittest.TestCase):
    ...
    def test_register_user(self):
        ...
        password = username
        login_service = LoginService("https://127.0.0.1", 8443)
    ...
    def test_init_session(self):
        shapelets = init_session("admin", "admin", "https://localhost", 8443)
    ...
    def test_init_session_only_with_server(self):
        ...
        _add_entry_to_login_file(
            ...
            port=8443,
            default=True)
        shapelets = init_session(address="https://localhost", port=8443)
        self.assertTrue(isinstance(shapelets, Shapelets))
