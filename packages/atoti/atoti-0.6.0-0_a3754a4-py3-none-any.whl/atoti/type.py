...
def _is_date(data_type: DataType) -> bool:
    """Whether data_type's java_type is of type date."""
    return data_type.java_type in [
        "LocalDate",
        "LocalDateTime",
        "LocalTime",
        "ZonedDateTime",
...
def _is_array(data_type: DataType) -> bool:
    """Whether data_type's java_type is of type array."""
