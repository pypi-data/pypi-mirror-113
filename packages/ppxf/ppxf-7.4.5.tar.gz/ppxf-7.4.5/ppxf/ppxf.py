...
class ppxf:
    ...
    .gas_bestfit:
        ...
        best-fitting gas spectrum alone. The best-fitting stellar spectrum alone
        can be computed as ``stars_bestfit = pp.bestfit - pp.gas_bestfit``
    .gas_flux:
