...
import icon from '../../assets/img/chiadoge_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Chia,Chiadoge Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Chiadoge-Network/chiadogecoin/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
