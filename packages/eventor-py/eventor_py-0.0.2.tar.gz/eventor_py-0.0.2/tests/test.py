...
tree = ET.parse(f"D:/PROGRAMMERING/Python/EventorPy2/tests/events.xml")
root = tree.getroot()
...
for event in events:
    ...
    event_list.append({"name": event_name, "discipline": event_distance, "organiser": event_organiser, "date": event_date})
...
saveXML("table.html", tabulate(event_list, tablefmt="html"))
