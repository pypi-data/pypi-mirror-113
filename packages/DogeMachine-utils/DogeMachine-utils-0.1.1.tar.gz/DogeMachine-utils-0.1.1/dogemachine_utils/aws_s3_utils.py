...
def get_report_object_key_path(url: str, scan_name: str, tool_name: str, time_string: str = None, file_extension: str = "txt"):
    """
    ...
    # 2012-03-17T1748Z
    # New approach as of July 20 2021:
    today = date.today()
    object_key = f"{today.strftime('%Y')}/" \
                 f"{today.strftime('%m')}/" \
                 f"{today.strftime('%d')}/" \
