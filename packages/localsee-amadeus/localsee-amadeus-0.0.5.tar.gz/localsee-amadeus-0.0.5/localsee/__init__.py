...
def single_shower(folder: str, path: str, select_area: tuple = (200, 200, 60, 60), show_area: tuple = (0, 0),
    ...
    # 带框框的图片
    rec = cv2.rectangle(ori_img, (select_x1 - border_size, select_y1 - border_size),
                        (select_x2 + border_size, select_y2 + border_size),
    ...
    rec2 = cv2.rectangle(rec, (sx1, sy1), (sx1 + select_width * scale, sy1 + select_height * scale), border_color,
                         border_size)
...
if __name__ == '__main__':
    path = args.path
    select_area = args.select_area
    show_area = args.show_area
    scale = args.scale
    border_size = args.border_size
    border_color = args.border_color
    path = '../Rain100L/norain-001.png'
