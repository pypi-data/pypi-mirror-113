...
from src.OpenHub.config_files import HAP_PYTHON_CHARACTERISTICS_FILE, HAP_PYTHON_SERVICES_FILE, HAP_PYTHON_ACCESSORIES_FILE
from src.OpenHub.hardware_interfaces.json import hardware_interface_decoder
from src.OpenHub.hardware_interfaces.channels.json.channel_decoder import ChannelDecoder
from src.OpenHub.globals import id_hardware_map, hardware_id_channels_map, id_channels_map, accessories, hub
import src.OpenHub.globals as glob
...
def setup_picos(COMS, hardwares, hardware_id_channels_map):
    ...
    for ser in COMS:
        ...
        for channel in hardware_id_channels_map[pico_serial]:
            ...
            from src.OpenHub.hardware_interfaces.channels.pi_pico_analog import PiPicoAnalog
...
def load_hub_config(hub):
    from src.OpenHub.homekit_accessories.json import homekit_decoder
