...
def to_java_object_array(seq: Collection[Any], *, gateway: JavaGateway) -> JavaArray:
...
def to_java_map(dictionary: Mapping[Any, Any], *, gateway: JavaGateway) -> JavaMap:
...
def to_java_string_array(seq: Collection[str], *, gateway: JavaGateway) -> JavaArray:
    """Transform the Python collection into a Java array of strings."""
    return to_typed_java_array(seq, gateway=gateway, array_type=gateway.jvm.String)


def to_java_object_list(seq: Collection[Any], *, gateway: JavaGateway) -> Any:
...
def to_java_date(
    date: Union[datetime.date, datetime.datetime], *, gateway: JavaGateway
) -> JavaObject:
...
def as_java_object(arg: Any, *, gateway: JavaGateway) -> Any:
