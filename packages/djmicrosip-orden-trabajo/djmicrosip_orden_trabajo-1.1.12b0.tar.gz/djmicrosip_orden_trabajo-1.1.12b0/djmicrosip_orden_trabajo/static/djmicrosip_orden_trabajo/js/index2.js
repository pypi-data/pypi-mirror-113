...
{	$(".fin_state").addClass("hidden");
		...
		if(progreso=="0")
	{
		...
		$("#change_state"+id_crm+" .change_state").html('Pendiente <span class="glyphicon glyphicon-step-forward" aria-hidden="true"></span>');
	...
	else if(progreso=="25")
	{
		...
		$("#change_state"+id_crm+" .change_state").html('En proceso <span class="glyphicon glyphicon-step-forward" aria-hidden="true"></span>');
	...
	else if(progreso=="50")
	{
		...
		$("#change_state"+id_crm+" .change_state").html('Terminado <span class="glyphicon glyphicon-step-forward" aria-hidden="true"></span>');
		$("#change_state"+id_crm+" .return_state").css("background-color","#dc3545");
		$("#change_state"+id_crm+" .return_state").html('<span class="glyphicon glyphicon-step-backward" aria-hidden="true"> Pendiente');
	}
	else if(progreso=="75")
	{
		$("#change_state"+id_crm).removeClass("hidden");
		...
		$("#change_state"+id_crm+" .return_state").html('<span class="glyphicon glyphicon-step-backward" aria-hidden="true"> En proceso');
	}
	else{
		$("#change_state"+id_crm).removeClass("hidden");
		$("#change_state"+id_crm+" .return_state").removeClass("hidden");
		...
		$("#change_state"+id_crm+" .return_state").html('<span class="glyphicon glyphicon-step-backward" aria-hidden="true"> Terminado');
	}
}
