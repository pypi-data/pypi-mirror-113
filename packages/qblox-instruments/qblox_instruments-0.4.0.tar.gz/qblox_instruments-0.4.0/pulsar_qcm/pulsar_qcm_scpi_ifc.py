    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.5.2 fwBuild=19/07/2021-07:40:37 fwHash=0x9436F8FF fwDirty=0 kmodVersion=0.5.2 kmodBuild=19/07/2021-07:40:37 kmodHash=0x9436F8FF kmodDirty=0 swVersion=0.5.2 swBuild=19/07/2021-07:40:37 swHash=0x9436F8FF swDirty=0"
                if build != build_ref:
