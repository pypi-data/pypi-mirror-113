...
def nuccell_zprojlabel_imgs(
    ...
    for s_file in sorted(os.listdir(s_ipath)):
        ...
        if not (o_match is None):
            ...
            try:
                ax[1,2].imshow(io.imread(s_segdir + config.d_nconv['s_format_tiff_celllabel_nuccellmatchedfeat'].format(s_slide_pxscene, s_seg_markers, i_nuc_diam, i_cell_diam)))
