...
def get_call_list(org_id: int, lang_code: str, start: str, end: str = "now",
         call_quantity: int = 0):
...
def pull(org_id: int, lang_code: str, start: str, end: str = "now",
         call_quantity: int = 0, output_json: Optional[str] = None):
