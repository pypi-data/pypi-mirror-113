...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Chiadogecoin requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Chiadoge-Network/chiadogecoin/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
...
echo ""
echo "Chiadogecoin  install.sh complete."
echo "For assistance join us on Discord in the #testnet chat channel:"
echo "https://discord.gg/invite/qK2x5zFUNx"
echo ""
echo "Try the Quick Start Guide to running chiadogecoin:"
echo "https://github.com/Chiadoge-Network/chiadogecoin/wiki/Quick-Start-Guide"
echo ""
