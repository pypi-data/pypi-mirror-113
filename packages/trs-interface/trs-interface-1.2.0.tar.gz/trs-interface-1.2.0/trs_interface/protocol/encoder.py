...
def get_delay_trigin_polarity(polarity:int=0) -> bytes:
    return pack(ID.GET_DELAY_TRIGIN_POLARITY, data=polarity)

def got_delay_trigin_polarity(polarity:int=0) -> bytes:
    return pack(ID.GOT_DELAY_TRIGIN_POLARITY, data=polarity)

def set_delay_trigin_polarity(polarity:int=0) -> bytes:
    return pack(ID.SET_DELAY_TRIGIN_POLARITY, data=polarity)
...
def start(start:int=0) -> bytes:
    return pack(ID.START, data=start)
