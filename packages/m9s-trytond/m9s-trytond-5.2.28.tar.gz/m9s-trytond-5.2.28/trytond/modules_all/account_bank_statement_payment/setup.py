#!/usr/bin/env python
# This file is part account_bank_statement_payment module for Tryton.
...
dependency_links = [
    ('hg+https://bitbucket.org/trytonspain/'
        'trytond-account_bank_statement_counterpart@%(branch)s'
        '#egg=trytonspain-account_bank_statement_counterpart-%(series)s' % {
            'branch': branch,
            'series': series,
            }),
    ('hg+https://bitbucket.org/trytonspain/'
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton Account Bank Statement Payment Module',
    ...
    convert_2to3_doctests=[
        'tests/scenario_account_bank_statement_payment_bank_discount.rst',
        ],
    )
