...
class sdist(MD,PIP,init):
      ...
      dir = Var.nameA.rstrip(".zip")+"ZIP"  if Var.nameA!=None else "cmds"
    ...
    setup(
        ...
        #         ('config', ['cfg/data.cfg'])],
          data_files=[
                  ...
                  ## !pip install Ngrok.zip==0.119 --prefix=/content
                  ## /content/NgrokZIP/ngrok
                  (f'{sdist.dir}', [f"{sdist.dir}{os.path.sep}ngrok"])
                  ## /content/ngrok
                #   ("ABC", [f"{sdist.dir}{os.path.sep}ngrok"])
          ],
          ...
          # https://qastack.cn/programming/1612733/including-non-python-files-with-setup-py
          #   package_data={'': ['license.txt']},
        #   package_data={'': [f'{sdist.dir}'+os.path.sep+"ngrok"]},
        #   include_package_data=True,
          # data_files=[
        #   data_files = [('', [f'{sdist.dir}'+os.path.sep+"ngrok",]),],
