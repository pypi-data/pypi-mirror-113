...
class Tests(unittest.TestCase):
    ...
    def test_gpsws2date(self):
        """Test gpswd2date function,
        use date: 2017-5-14, GPS week: 1949, seconds of week: 3.
        """
        date = gnsscal.gpsws2date(1949, 3)

        self.assertEqual(date, datetime.datetime(2017, 5, 14, 0, 0, 3))
        with self.assertRaises(ValueError):
            gnsscal.gpsws2date(-1, 0)
            gnsscal.gpsws2date(0, -1)
            gnsscal.gpsws2date(-1, -1)
