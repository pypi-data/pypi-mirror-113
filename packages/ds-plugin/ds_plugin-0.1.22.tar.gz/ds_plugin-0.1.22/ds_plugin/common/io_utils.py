...
from ds_plugin.common.fs.file_system import _stringify_path, LocalFileSystem
from ds_plugin.common.fs import hdfs
...
def resolve_filesystem_and_path(where, is_uri=False):
    ...
    if parsed_uri.scheme == "hdfs":
        ...
        logging.warning("netloc_split: %s", netloc_split)
        host = netloc_split[0]
        if host == "":
            host = "mlcluster"
        else:
