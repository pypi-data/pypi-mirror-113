...
class FunctionsService(BaseService):
    ...
    def register_custom_function(self,
        ...
        self._register_function(
            FunctionType.REGULAR, custom_function, description, force)
    ...
    def register_custom_splitter(self,
        ...
        """
        self._register_function(
            FunctionType.SPLITTER, custom_function, description, force)
    ...
    def register_custom_reducer(self,
        ...
        """
        self._register_function(
            FunctionType.REDUCER, custom_function, description, force)
...
def _algorithmic_spec(function_name: str,
                      ...
                      description: FunctionDescription = None) -> typing.Dict:
    if description is None:
        description = FunctionDescription(function_name)
