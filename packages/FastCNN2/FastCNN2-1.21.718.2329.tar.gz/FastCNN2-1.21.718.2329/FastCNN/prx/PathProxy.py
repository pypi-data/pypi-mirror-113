...
class PathProxy2:
    ...
    def getTrainCKPTPath(projectid,modelid):
        return os.path.join(PathProxy2.app_path,"Projects",projectid,modelid,"TrainSaver")
    ...
    def getValidCKPTPath(projectid,modelid):
        return os.path.join(PathProxy2.app_path,"Projects",projectid,modelid,"ValidSaver")
