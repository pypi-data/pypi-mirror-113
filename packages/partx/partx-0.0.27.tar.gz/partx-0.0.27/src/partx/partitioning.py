...
from staliro.optimizers import ObjectiveFn, Optimizer, Run
...
def _optimize(func: ObjectiveFn, options: StaliroOptions, optimizer_options: PartitioningOptions) -> PartitioningRun:
