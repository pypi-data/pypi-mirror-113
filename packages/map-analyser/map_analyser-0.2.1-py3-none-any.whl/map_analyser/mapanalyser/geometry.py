...
def _decomp4(area):
    ...
    # try:
    #     ret = func_timeout(1000, Polygon.convex_decompose, args=(Polygon.from_tuples(area.coords_zipped),
    ...
    ret = Polygon.convex_decompose(Polygon.from_tuples(area.coords_zipped), [Polygon.from_tuples(hole) for hole in area.holes])
