...
def load_configuration(app):
    ...
    present but `ps_config.py.example` is, copies the latter as the
    former first.
    """
    try:
        ...
        if os.path.exists('ps_config.py.example'):
            ...
            raise IOError(
                (
                    ...
                    " available or there was an error loading"
                    " 'ps_config.py'; unable to find server configuration in"
                    " run directory {}. Original error was: {}"
...
def enable_talisman(app):
    ...
    if USE_TALISMAN:
        ...
        # Add csp_nonce global dummy since flask_talisman won't
