...
class _ReadPrivateParameters:
    is_parameter_table: Optional[bool] = False


@dataclass(frozen=True)
class _ReadParquetPrivateParameters(
    _LoadParquetPrivateParameters, _ReadPrivateParameters
):
...
class Session(LocalSession[Cubes]):
    ...
    def read_csv(
        ...
        **kwargs: Any,
        ...
        """
        private_parameters = _ReadPrivateParameters(**kwargs)
        ...
        CsvDataSource(self._java_api).create_table_from_csv(
            path=path,
            table_name=table_name,
            keys=keys,
            separator=separator,
    ...
    def read_parquet(
        ...
        **kwargs: Any,
        ...
        ParquetDataSource(self._java_api).create_table_from_parquet(
            path=path,
            table_name=table_name,
            keys=keys,
            partitioning=partitioning,
            ...
            _types=private_parameters._types,
        )
        return _create_table(self._java_api, table_name)
    ...
    def start_transaction(self, scenario_name: str = BASE_SCENARIO) -> Transaction:
