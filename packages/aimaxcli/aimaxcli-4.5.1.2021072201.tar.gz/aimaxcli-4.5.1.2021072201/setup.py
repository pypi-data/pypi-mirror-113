...
setup(
    ...
    entry_points={
        ...
        'aimax.client': [
            ...
            'user batchadd = aimaxcmd.com_batch:CommonBatchAdd',# addUser 增加用户
            ...
            'user delHarb orUser = aimaxcmd.com_list:CommonDelete',# updateUser 更新用户
