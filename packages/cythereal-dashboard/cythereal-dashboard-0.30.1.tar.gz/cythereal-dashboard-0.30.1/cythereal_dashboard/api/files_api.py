...
class FilesApi(object):
    ...
    def list_av_data(self, files, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str files: The SHA1 of the file to get info for.  Specify parameter as a comma separated string.  (required)
    ...
    def list_file_info(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_info(files, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str files: The SHA1 of the files to get info for. Specify parameter as a comma separated string.  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_file_info_with_http_info(files, **kwargs)  # noqa: E501
        else:
            (data) = self.list_file_info_with_http_info(files, **kwargs)  # noqa: E501
            return data

    def list_file_info_with_http_info(self, files, **kwargs):  # noqa: E501
        """Takes a list of hashes and returns a list of their info  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_file_info_with_http_info(files, async_req=True)
        >>> result = thread.get()
        ...
        if ('files' not in params or
                params['files'] is None):
            raise ValueError("Missing the required parameter `files` when calling `list_file_info`")  # noqa: E501
