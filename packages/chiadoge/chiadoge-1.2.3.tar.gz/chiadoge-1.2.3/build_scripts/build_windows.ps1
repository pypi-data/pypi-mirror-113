...
Write-Output "   ---"
Write-Output "Build chiadoge wheels"
Write-Output "   ---"
pip wheel --use-pep517 --extra-index-url https://pypi.chia.net/simple/ -f . --wheel-dir=.\build_scripts\win_build .

Write-Output "   ---"
Write-Output "Install chiadoge wheels into venv with pip"
Write-Output "   ---"
...
Write-Output "pip install chiadoge"
pip install --no-index --find-links=.\win_build\ chiadoge
...
Write-Output "   ---"
Write-Output "Copy chiadoge executables to chiadogecoin-gui\"
Write-Output "   ---"
Copy-Item "dist\daemon" -Destination "..\chiadogecoin-gui\" -Recurse
Set-Location -Path "..\chiadogecoin-gui" -PassThru
