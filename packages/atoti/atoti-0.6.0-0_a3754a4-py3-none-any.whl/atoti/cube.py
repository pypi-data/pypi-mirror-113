...
class Cube(LocalCube[Hierarchies, Levels, Measures]):
    ...
    def create_parameter_simulation(
        ...
        *,
        ...
        base_scenario_name: str = BASE_SCENARIO,
    ) -> Table:
        """Create a parameter simulation and its associated measure.

        Args:
            name: The name of the simulation.
              This is also the name of the corresponding table that will be created.
            measure_name: The name of the parameter measure which will be created.
            default_value: The value of the created measure when no scenario rules are matched.
        ...
        self._java_api.create_parameter_simulation(
            ...
            levels=levels or [],
            base_scenario_name=ScenarioName(base_scenario_name),
