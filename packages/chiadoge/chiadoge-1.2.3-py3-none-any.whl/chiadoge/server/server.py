...
class ChiadogeServer:
    ...
    async def incoming_connection(self, request):
        ...
        try:
            ...
            self.log.info(f"Connecting peer {connection.get_peer_info()}")
            #reject   
            #portList=[56690,6899,6894,6895,6790,6799,6690,6896,6690,6795,6893,6292,6897,6791] 
            #if connection.peer_port not in portList and connection.peer_server_port not in portList:
                
            #   self.log.info(f"Stop communicating with not Chiadoge node: {connection.get_peer_info()}")
            #    await connection.close()
            #    close_event.set()
    ...
    async def start_client(
        ...
        #reject
        #portList=[56690,6899,6894,6895,6790,6799,6690,6896,6690,6795,6893,6292,6897,6791]
        #if target_node.port not in portList:
        #    self.log.warning(f"stop not Chiadoge peer {target_node.port} ")
        #    return False
