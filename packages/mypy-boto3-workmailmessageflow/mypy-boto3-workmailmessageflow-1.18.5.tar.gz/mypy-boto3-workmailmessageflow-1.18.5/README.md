...
[boto3.WorkMailMessageFlow 1.18.5](https://boto3.amazonaws.com/v1/documentation/api/1.18.5/reference/services/workmailmessageflow.html#WorkMailMessageFlow)
