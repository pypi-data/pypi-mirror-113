...
class EncoderWrap:
    # TODO make this an omlet utility, it's reusable!!
    "intentionally not nn.Module to prevent DDP unused parameter error"
...
class TSMEncoder(nn.Module):
    ...
    def __init__(self, obs_shape, feature_dim):
        super().__init__()
        raise NotImplementedError('TODO make this not detached')
...
class Actor(nn.Module):
    ...
    def __init__(self, encoder, action_shape, hidden_dim, hidden_depth, log_std_bounds):
        ...
        self.encoder = EncoderWrap(encoder)
