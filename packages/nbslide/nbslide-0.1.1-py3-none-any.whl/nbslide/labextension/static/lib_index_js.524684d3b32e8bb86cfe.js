...
const plugin = {
    ...
    activate: (app, pallete, tracker) => {
        ...
        const commands = new _commands__WEBPACK_IMPORTED_MODULE_2__.Commands(app, pallete, tracker);
...
class NbSlide {
    ...
    createNew(widget, context) {
        ...
        const slideControl = new _slidecontrol__WEBPACK_IMPORTED_MODULE_1__.SlideControl(widget, this.commands);
...
//# sourceMappingURL=lib_index_js.524684d3b32e8bb86cfe.js.map