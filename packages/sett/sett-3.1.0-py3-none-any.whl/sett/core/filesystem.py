...
from typing import List, Iterator, Union, Sequence
...
def check_space(files: Sequence[str], dest: str, force: bool = False):
    required_space = sum(os.path.getsize(path) for path in files)
