...
class Dci:
	...
	def ar1(self):
		...
		if not hasattr(self, '_ar1'):
			from .Ar1 import Ar1
			self._ar1 = Ar1(self._core, self._base)
		return self._ar1
	...
	def ar10(self):
		...
		if not hasattr(self, '_ar10'):
			...
			self._ar10 = Ar10(self._core, self._base)
		return self._ar10
	...
	def ar11(self):
		...
		if not hasattr(self, '_ar11'):
			...
			self._ar11 = Ar11(self._core, self._base)
		return self._ar11
	...
	def ar12(self):
		...
		if not hasattr(self, '_ar12'):
			...
			self._ar12 = Ar12(self._core, self._base)
		return self._ar12
	...
	def ar13(self):
		...
		if not hasattr(self, '_ar13'):
			...
			self._ar13 = Ar13(self._core, self._base)
		return self._ar13
	...
	def ar14(self):
		...
		if not hasattr(self, '_ar14'):
			...
			self._ar14 = Ar14(self._core, self._base)
		return self._ar14
	...
	def ar15(self):
		...
		if not hasattr(self, '_ar15'):
			...
			self._ar15 = Ar15(self._core, self._base)
		return self._ar15
	...
	def ar16(self):
		...
		if not hasattr(self, '_ar16'):
			...
			self._ar16 = Ar16(self._core, self._base)
		return self._ar16
	...
	def ar2(self):
		...
		if not hasattr(self, '_ar2'):
			from .Ar2 import Ar2
			self._ar2 = Ar2(self._core, self._base)
		return self._ar2
	...
	def ar3(self):
		...
		if not hasattr(self, '_ar3'):
			from .Ar3 import Ar3
			self._ar3 = Ar3(self._core, self._base)
		return self._ar3
	...
	def ar4(self):
		...
		if not hasattr(self, '_ar4'):
			from .Ar4 import Ar4
			self._ar4 = Ar4(self._core, self._base)
		return self._ar4
	...
	def ar5(self):
		...
		if not hasattr(self, '_ar5'):
			from .Ar5 import Ar5
			self._ar5 = Ar5(self._core, self._base)
		return self._ar5
	...
	def ar6(self):
		...
		if not hasattr(self, '_ar6'):
			from .Ar6 import Ar6
			self._ar6 = Ar6(self._core, self._base)
		return self._ar6
	...
	def ar7(self):
		...
		if not hasattr(self, '_ar7'):
			from .Ar7 import Ar7
			self._ar7 = Ar7(self._core, self._base)
		return self._ar7
	...
	def ar8(self):
		...
		if not hasattr(self, '_ar8'):
			from .Ar8 import Ar8
			self._ar8 = Ar8(self._core, self._base)
		return self._ar8
	...
	def ar9(self):
		...
		if not hasattr(self, '_ar9'):
			from .Ar9 import Ar9
			self._ar9 = Ar9(self._core, self._base)
		return self._ar9
	...
	def caCpext(self):
		...
		if not hasattr(self, '_caCpext'):
			...
			self._caCpext = CaCpext(self._core, self._base)
	...
	def cd1(self):
		...
		if not hasattr(self, '_cd1'):
			from .Cd1 import Cd1
			self._cd1 = Cd1(self._core, self._base)
		return self._cd1
	...
	def cd10(self):
		...
		if not hasattr(self, '_cd10'):
			...
			self._cd10 = Cd10(self._core, self._base)
		return self._cd10
	...
	def cd11(self):
		...
		if not hasattr(self, '_cd11'):
			...
			self._cd11 = Cd11(self._core, self._base)
		return self._cd11
	...
	def cd12(self):
		...
		if not hasattr(self, '_cd12'):
			...
			self._cd12 = Cd12(self._core, self._base)
		return self._cd12
	...
	def cd13(self):
		...
		if not hasattr(self, '_cd13'):
			...
			self._cd13 = Cd13(self._core, self._base)
		return self._cd13
	...
	def cd14(self):
		...
		if not hasattr(self, '_cd14'):
			...
			self._cd14 = Cd14(self._core, self._base)
		return self._cd14
	...
	def cd15(self):
		...
		if not hasattr(self, '_cd15'):
			...
			self._cd15 = Cd15(self._core, self._base)
		return self._cd15
	...
	def cd16(self):
		...
		if not hasattr(self, '_cd16'):
			...
			self._cd16 = Cd16(self._core, self._base)
		return self._cd16
	...
	def cd2(self):
		...
		if not hasattr(self, '_cd2'):
			from .Cd2 import Cd2
			self._cd2 = Cd2(self._core, self._base)
		return self._cd2
	...
	def cd3(self):
		...
		if not hasattr(self, '_cd3'):
			from .Cd3 import Cd3
			self._cd3 = Cd3(self._core, self._base)
		return self._cd3
	...
	def cd4(self):
		...
		if not hasattr(self, '_cd4'):
			from .Cd4 import Cd4
			self._cd4 = Cd4(self._core, self._base)
		return self._cd4
	...
	def cd5(self):
		...
		if not hasattr(self, '_cd5'):
			from .Cd5 import Cd5
			self._cd5 = Cd5(self._core, self._base)
		return self._cd5
	...
	def cd6(self):
		...
		if not hasattr(self, '_cd6'):
			from .Cd6 import Cd6
			self._cd6 = Cd6(self._core, self._base)
		return self._cd6
	...
	def cd7(self):
		...
		if not hasattr(self, '_cd7'):
			from .Cd7 import Cd7
			self._cd7 = Cd7(self._core, self._base)
		return self._cd7
	...
	def cd8(self):
		...
		if not hasattr(self, '_cd8'):
			from .Cd8 import Cd8
			self._cd8 = Cd8(self._core, self._base)
		return self._cd8
	...
	def cd9(self):
		...
		if not hasattr(self, '_cd9'):
			from .Cd9 import Cd9
			self._cd9 = Cd9(self._core, self._base)
		return self._cd9
	...
	def dfiFlag(self):
		...
		if not hasattr(self, '_dfiFlag'):
			...
			self._dfiFlag = DfiFlag(self._core, self._base)
	...
	def dmss(self):
		...
		if not hasattr(self, '_dmss'):
			...
			self._dmss = Dmss(self._core, self._base)
		return self._dmss
	...
	def haaBitmap(self):
		...
		if not hasattr(self, '_haaBitmap'):
			...
			self._haaBitmap = HaaBitmap(self._core, self._base)
	...
	def hqaRequest(self):
		...
		if not hasattr(self, '_hqaRequest'):
			...
			self._hqaRequest = HqaRequest(self._core, self._base)
	...
	def insPatt(self):
		...
		if not hasattr(self, '_insPatt'):
			...
			self._insPatt = InsPatt(self._core, self._base)
	...
	def lsbsfn(self):
		...
		if not hasattr(self, '_lsbsfn'):
			...
			self._lsbsfn = Lsbsfn(self._core, self._base)
		return self._lsbsfn
	...
	def nfIndicator(self):
		...
		if not hasattr(self, '_nfIndicator'):
			...
			self._nfIndicator = NfIndicator(self._core, self._base)
	...
	def nrpGroups(self):
		...
		if not hasattr(self, '_nrpGroups'):
			...
			self._nrpGroups = NrpGroups(self._core, self._base)
	...
	def olIndicator(self):
		...
		if not hasattr(self, '_olIndicator'):
			...
			self._olIndicator = OlIndicator(self._core, self._base)
	...
	def pgIndex(self):
		...
		if not hasattr(self, '_pgIndex'):
			...
			self._pgIndex = PgIndex(self._core, self._base)
	...
	def sgs1(self):
		...
		if not hasattr(self, '_sgs1'):
			...
			self._sgs1 = Sgs1(self._core, self._base)
		return self._sgs1
	...
	def sgs2(self):
		...
		if not hasattr(self, '_sgs2'):
			...
			self._sgs2 = Sgs2(self._core, self._base)
		return self._sgs2
	...
	def sgs3(self):
		...
		if not hasattr(self, '_sgs3'):
			...
			self._sgs3 = Sgs3(self._core, self._base)
		return self._sgs3
	...
	def sgs4(self):
		...
		if not hasattr(self, '_sgs4'):
			...
			self._sgs4 = Sgs4(self._core, self._base)
		return self._sgs4
