...
from src.OpenHubAPI.data.forms.forms import HardwareForm, HardwareDHT22Form, HardwareMCP3008Form, HardwareModProbeForm, \
...
from src.OpenHubAPI.data.models.models import Hardware, DHT22, MCP3008, ModProbe, PiPico, VEML7700, Accessory, Calibration, \
    CalibrationConstants, Channel, Hub, HardwareIO
from src.OpenHubAPI.data.serializers.serializers import HardwareSerializer, ChannelSerializer, AccessorySerializer, \
...
class ChannelViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        print('retrieve')
        print(str(request.path_info))
        hardware_io_type_form = HardwareIOTypeForm(initial={'parent_hardware': Channel.objects.get(**kwargs).hardware.id,
