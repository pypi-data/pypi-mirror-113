...
def feature_correct_labels(
    ...
    for s_file in sorted(os.listdir(s_path_seg)):
        ...
        if not (o_match is None):
            ...
            io.imsave(s_segdir + config.d_nconv['s_format_tiff_celllabel_nuccellmatchedfeat'].format(s_slide_fscene, s_seg_markers, i_nuc_diam, i_cell_diam), ai_label_cellnucexp)
