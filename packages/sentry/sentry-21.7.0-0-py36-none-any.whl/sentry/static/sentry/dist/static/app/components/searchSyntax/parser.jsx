...
var listJoiner = function (_a) {
    var _b = tslib_1.__read(_a, 4), s1 = _b[0], comma = _b[1], s2 = _b[2], value = _b[3];
    return ({
...
var TokenConverter = /** @class */ (function () {
    function TokenConverter(_a) {
         ...
         */
        this.makeToken = function (args) { return (tslib_1.__assign({ text: _this.text(), location: _this.location() }, args)); };
        ...
        this.tokenKeyAggregateArgs = function (arg1, args) {
            return _this.makeToken({
                ...
                args: tslib_1.__spreadArray([{ separator: '', value: arg1 }], tslib_1.__read(args.map(listJoiner))),
            });
        };
        ...
        this.tokenValueNumberList = function (item1, items) {
            return _this.makeToken({
                ...
                items: tslib_1.__spreadArray([{ separator: '', value: item1 }], tslib_1.__read(items.map(listJoiner))),
            });
        };
