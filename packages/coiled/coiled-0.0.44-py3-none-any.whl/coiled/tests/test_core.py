...
from backends.utils import get_gcp_region_from_zone
...
def test_set_backend_options_gcp_vm_coiled_hosted(cloud, sample_user):
    ...
    assert account.options == {
        "gcp_region_name": get_gcp_region_from_zone(settings.GCP_DEFAULT_USER_REGION),
        "gcp_zone_name": settings.GCP_DEFAULT_USER_REGION,
    }
    assert account.container_registry == {
        "type": ContainerRegistryType.ECR,
        "credentials": {},
