...
poke_es_shrunk_markerpartition = peek_es_shrunk_markerpartition
...
feat.filter_features(
    ...
    es_shrunk_markerpartition = poke_es_shrunk_markerpartition,  # optional against beedthroigh
    es_slidepxscene_cellline = poke_es_slidepxscene_cellline,  # optional celllines will be treated like turmor cells
