...
class LibreArticuloBase(models.Model):
    articulo_id=models.IntegerField(primary_key=True, db_column='ARTICULO_ID')
    no_serie=models.CharField(max_length=20, db_column="NO_SERIE")
    fecha_compra=models.DateTimeField(db_column='FECHA_COMPRA', blank=True, null=True)
    costo=models.IntegerField(null=True, db_column='COSTO')
    refaccion=models.IntegerField(null=True, db_column='REFACCION')
    flete=models.IntegerField(null=True, db_column='FLETE')
    class Meta:
        db_table = u'LIBRES_ARTICULOS'
        abstract = True

    def __str__( self ):
        return u'%s' % (self.articulo_id)
