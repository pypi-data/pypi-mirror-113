"""
Set of functions that are used both in the django backend and in the graphene authentication
middleware
"""
...
def get_authenticating_token(request: HttpRequest, jwt_auth_header_prefix: str = None, token_authentication_header_name: str = None, jwt_access_token_name: str = None, jwt_api_token_name: str = None, allow_argument: bool = True, **kwargs) -> Optional[str]:
    """
    Fetch a token from the graphql request.
    ...
    :param token_authentication_header_name:
    :param jwt_access_token_name:
    :param jwt_api_token_name:
    ...
    result = get_authentication_token_in_graphql_argument(
        request=request,
        jwt_api_token_name=jwt_access_token_name,
...
def get_authentication_token_in_graphql_argument(request: HttpRequest, jwt_api_token_name: str = None, allow_argument: bool = True, **kwargs) -> Optional[str]:
    """
