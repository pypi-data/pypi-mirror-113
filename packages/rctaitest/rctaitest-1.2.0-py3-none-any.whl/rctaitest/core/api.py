# -*- coding: utf-8 -*-
"""
This module contains the rctaitest Core APIs.
"""
import os
import time
...
from rctaitest.core.cv import Template, loop_find, try_log_screen
from rctaitest.core.error import TargetNotFoundError
from rctaitest.core.settings import Settings as ST
from rctaitest.utils.compat import script_log_dir
from rctaitest.core.helper import (G, delay_after_operation, import_device_cls,
    ...
    :Example:
        ...
        * ``Android``: it is equivalent to executing ``adb shell input keyevent KEYNAME`` ::
        ...
        .. seealso::
           ...
           Module :py:mod:`rctaitest.core.android.adb.ADB.keyevent`
        ...
        * ``Windows``: Use ``pywinauto.keyboard`` module for key input::
        ...
        .. seealso::
            ...
            Module :py:mod:`rctaitest.core.win.win.Windows.keyevent`
...
def text(text, enter=True, **kwargs):
    ...
    :Example:
        ...
        .. seealso::
            ...
            Module :py:mod:`rctaitest.core.android.ime.YosemiteIme.code`
