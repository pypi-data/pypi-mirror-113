...
TOPICWORDS = [ "([A-Za-z]+-)+\w+",{"token": "no", "tokenType": "negation"},{"token": "negative", "tokenType": "negation"},
                    ...
                    if "nearby" in rule:
                        ...
                        for nearby in rule["nearby"]:
                            if "startOffset" in nearby:
                                start = i + nearby["startOffset"]
                            if "endOffset" in nearby:
                                end = i + nearby["endOffset"]
                            ...
                            for j in range(start, end):
                                ...
                                if j >=len(tokens):
                                    continue
                                if replaceMeaninglessPunc(tokens[j][nearby["spanType"]]) in nearby["spans"]:
