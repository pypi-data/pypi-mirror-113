...
# 1. valid standard cellpartition are: Nuclei, Ring, Nucmem, Cytomem
...
es_markerpartition_standard = {
    '53BP1_Nuclei',
    'AR_Nuclei', 'aSMA_Ring',
    'BAX_Nuclei', 'BCL2_Ring', 'BMP2_Ring', 'BMP4_Ring', 'BMP6_Ring',
    ...
    'CSF1R_Ring',
    'DAPI_Nuclei',
    'EGFR_Ring','EGFR_Cytomem', 'ER_Nuclei', 'Ecad_Ring','Ecad_Cytomem',
    'F480_Ring', 'FN1_Ring', 'FoxP3_Nuclei',
    'GATA3_Nuclei', 'GATA6_Nuclei', 'gH2AX_Nuclei', 'Glut1_Ring', 'GRNZB_Nuclei',
    'H3K4_Nuclei', 'H3K27_Nuclei', 'HER2_Ring','HER2_Cytomem', 'HIF1a_Nuclei',
    ...
    'p63_Nuclei','p63_Ring', 'pAKT_Ring', 'pERK_Nuclei', 'pERK_Ring', 'pHH3_Nuclei', 'pMYC_Nuclei', 'pRB_Nuclei',  'pS62MYC_Nuclei', 'pS6RP_Ring', 'panCK_Ring', # kicked pRb_Nuclei
    'RAD51_Nuclei',
    'S100_Ring', 'SYP_Ring',
...
d_nconv = {
    ...
    's_format_csv_controidxy': 'features_{}_CentroidXY.csv',  # s_slide   # centroid xy and cell shape information
    's_format_csv_shape_filteredmeanintenisty': 'features_{}_FilteredMeanIntensity_{}.csv', # s_slide s_filter_dapi
    's_format_csv_centroid_shape_meanintenisty': 'features_{}_MeanIntensity_Centroid_Shape.csv',  # s_slide
}
