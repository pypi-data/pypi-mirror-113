from src.OpenHub.hardware_interfaces import mod_probe, dht22, mcp3008, veml_7700
from src.OpenHub.initializers.homekit_interfaces.first_time_kit_setup import interface_channel_with_homekit_accessory
import board
