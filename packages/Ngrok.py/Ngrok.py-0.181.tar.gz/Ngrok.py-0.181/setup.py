                  ...
                  if __name__=="__main__":
                    ...
                    class QQ:
                        def __new__(cls):
                            ...
                            # os.chdir(home)
                            print("@ 1 @",os.popen("ngrok").read())
                            print("@ 2 @",os.popen("/usr/local/ngrok").read())
                            ...
                            os.system('ngrok authtoken '+ID)     ##  /root/.ngrok2/ngrok.yml
                            os.system("ngrok http -config=/root/.ngrok2/ngrok.yml "+str(POPO)+'&')  ## https://c5eba03d.ngrok.io
                            ...
                            while True:
                                ...
                                # if os.popen("curl -s http://localhost:4040/api/tunnels").read().find("ERR_NGROK_108")!=-1:
