...
class carsharing_registration_request(models.Model):
  ...
  def compute_request(self,task_creation=False):
    ...
    if self.group_index:
      ...
      app_db_utils.update_system_group_from_app_group(self,company.sm_user_person_group_prepaiment)
  ...
  def _compute_registration_group(self):
    ...
    if self.group_index:
      ...
      if self.ba_behaviour == 'no_ba':
        ...
        computed_group_index = company.sm_user_person_group_prepaiment
