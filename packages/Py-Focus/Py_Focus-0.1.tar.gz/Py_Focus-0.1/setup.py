...
setup(
  ...
  url = 'https://github.com/fcaprile/Py_Focus',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/fcaprile/Py_Focus/archive/refs/tags/0.1.tar.gz',    # I explain this later on
