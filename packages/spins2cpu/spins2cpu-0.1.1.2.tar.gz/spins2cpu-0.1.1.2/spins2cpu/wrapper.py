...
''',
    ...
    parser.add_argument('-v', "--version", action="version", version="spins2cpu 0.1.1.2")
    ...
    parser.add_argument('-c', "--config", default="triangle", type=str.lower,
                        choices=['triangle', 'c_rectangle', 'ammm', 'square', 'rectangle', 'honeycomb', 'p6mmm', 'i_p6mmm', 'p3m1', 'kagome', 'cube'])
