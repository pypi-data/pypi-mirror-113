...
function Grouping(_a) {
    var _b, _c;
    var api = _a.api, groupId = _a.groupId, location = _a.location, organization = _a.organization, router = _a.router;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _b = tslib_1.__read.apply(void 0, [_c.sent(), 3]), response = _b[0], xhr = _b[2];
    ...
    if (error) {
        return <errorMessage_1.default onRetry={fetchGroupingLevels} groupId={groupId} error={error}/>;
    }
...
var Header = styled_1.default('p')(templateObject_2 || (templateObject_2 = tslib_1.__makeTemplateObject(["\n  && {\n    margin-bottom: ", ";\n  }\n"], ["\n  && {\n    margin-bottom: ", ";\n  }\n"])), space_1.default(2));
var Body = styled_1.default('div')(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  display: grid;\n  grid-gap: ", ";\n"], ["\n  display: grid;\n  grid-gap: ", ";\n"])), space_1.default(3));
