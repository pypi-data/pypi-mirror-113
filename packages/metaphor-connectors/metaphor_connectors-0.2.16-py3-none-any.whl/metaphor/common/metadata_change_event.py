...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, comments, dataset_created_at, deleted_at, documentation, entity_type, dataset_id, last_modified_at, logical_id, ownership, properties, schema, statistics, support_info, upstream)
