...
class AwsS3TestCase(unittest.TestCase):
    ...
    def test_get_report_path_case_0(self):
        ...
        print(result)
        expected_result = f"{self.date_string_prefix}/vulnweb.com/vulnweb.com/root/rxss/zap/1023Z.xml"
    ...
    def test_get_report_path_case_1(self):
        ...
        print(result)
        expected_result = f"{self.date_string_prefix}/vulnweb.com/testphp.vulnweb.com/root/rxss/zap/1023Z.xml"
        self.assertEqual(result, expected_result)
    ...
    def test_get_report_path_case_2(self):
        ...
        expected_result = f"{self.date_string_prefix}/vulnweb.com/testphp.vulnweb.com/sup/rxss/zap/1023Z.xml"
        print(result)
        self.assertEqual(result, expected_result)
    ...
    def test_get_report_path_case_3(self):
        ...
        expected_result = f"{self.date_string_prefix}/vulnweb.com/testphp.vulnweb.com/sup+bruh+yolo/rxss/zap/1023Z.xml"
        print(result)
        self.assertEqual(result, expected_result)
