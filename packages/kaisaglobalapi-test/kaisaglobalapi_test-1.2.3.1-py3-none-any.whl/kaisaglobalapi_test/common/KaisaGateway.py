...
class KaisaGateway(object):
    ...
    def init_open_md_api(self):
        ...
        print(f'md_api-开始重连, 更新时间:{datetime.datetime.now()}')
        # 请求登录和初始化行情api
    ...
    def trade_connect(self):
        ...
        """
        ret_ok, ret_msg, rt_userid, rt_token = self.gateway_auth()
        if ret_ok:
