###############################################################################
#
# Copyright (C) 2016-2021, Michele Cappellari
...
def age_metal(filename):
    ...
    downloaded from http://miles.iac.es/ as of 2021
...
class miles:
    ...
    library by `Vazdekis et al. (2010) <https://ui.adsabs.harvard.edu/abs/2010MNRAS.404.1639V>`_.
    ...
    .log_lam_temp: array_like with shape (npixels,)
