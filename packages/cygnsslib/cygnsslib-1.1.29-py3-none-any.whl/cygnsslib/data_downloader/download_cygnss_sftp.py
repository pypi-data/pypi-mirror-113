...
def find_file_name_in_dir(dir_data: list, data_year: int, data_day: int, sc_num: int) -> Optional[str]:
    cyg_file_name = None
...
def check_file_exit(year, day, sc_num, out_main_folder):
...
def download_cygnss_data_from_sftp(year: int, list_days: Union[list, np.ndarray], list_sc: Union[list, np.ndarray], out_main_folder: str,
                                   data_path_sftp: Optional[str] = None, save_username_pass: bool = True, reset_pass: bool = False):
    """
