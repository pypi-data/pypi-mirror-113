...
var SummaryContent = /** @class */ (function (_super) {
    ...
    SummaryContent.prototype.render = function () {
        ...
        <header_1.default eventView={eventView} location={location} organization={organization} projects={projects} transactionName={transactionName} currentTab={header_1.Tab.TransactionSummary} hasWebVitals={hasWebVitals} handleIncompatibleQuery={this.handleIncompatibleQuery} onChangeThreshold={onChangeThreshold}/>
        <Layout.Body>
          ...
          <Layout.Main>
            ...
            <charts_1.default organization={organization} location={location} eventView={eventView} totalValues={totalCount} currentFilter={spanOperationBreakdownFilter}/>
          ...
          <Layout.Side>
            ...
            <statusBreakdown_1.default eventView={eventView} organization={organization} location={location}/>
