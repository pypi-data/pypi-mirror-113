...
class TestHilbertSpace:
    ...
    @staticmethod
    def hilbertspace_initialize_legacy():
    ...
    def test_HilbertSpace_init(self):
        _ = self.hilbertspace_initialize_legacy()

    def build_hamiltonian(self):
        hilbertspc = self.hilbertspace_initialize_legacy()
    ...
    def test_HilbertSpace_eigenenergies(self):
        hilbertspace = self.hilbertspace_initialize_legacy()
