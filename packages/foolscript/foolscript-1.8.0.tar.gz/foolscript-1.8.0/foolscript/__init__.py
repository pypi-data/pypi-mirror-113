...
class BuiltInFunction(BaseFunction):
  ...
  def execute_leng(self, exec_ctx):
        return RTResult().success(len(str(exec_ctx.symbol_table.get('value'))))
  ...
  def execute_wait(self, exec_ctx):
    n = int(str(exec_ctx.symbol_table.get('value')))
    time.sleep(n)
    return RTResult().success(Number.null)
  ...
  def execute_lower(self, exec_ctx):
        n = str(exec_ctx.symbol_table.get('value')).lower()
        return RTResult().success(String(str(n)))
        # return RTResult().success(Number.null)

  execute_lower.arg_names = ["value"]

  def execute_upper(self, exec_ctx):
        n = str(exec_ctx.symbol_table.get('value')).upper()
        return RTResult().success(String(str(n)))
        # return RTResult().success(Number.null)
  ...
  def execute_rand(self, exec_ctx):
        ran = int(random.randint(int(str(exec_ctx.symbol_table.get('value'))), int(str(exec_ctx.symbol_table.get('value2')))))
        return RTResult().success(Number(ran))
       
  execute_rand.arg_names = ['value', 'value2']
  ...
  def execute_run(self, exec_ctx):
    ...
    fn = fn.value
    try:
      with open(user_pref.working_project_directory + fn, "r") as f:
        script = f.read()
