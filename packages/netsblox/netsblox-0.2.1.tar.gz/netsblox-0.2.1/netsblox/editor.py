...
class HumanMortalityDatabase:
    ...
    def get_time_series(self, country: str, gender: Optional[Any] = None, category: Optional[Any] = None) -> list:
        '''
...
class Thingspeak:
    ...
    def search_by_tag_and_location(self, tag: str, latitude: float, longitude: float, distance: Optional[float] = None):
        '''
