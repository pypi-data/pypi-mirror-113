...
def degrees_ger() -> list:
    try:
        with open('./src/persontitles/academic_german.txt', mode='r', encoding='utf-8') as fin:  # noqa
        ...
        with open('./src/persontitles/academic_german.txt', mode='a', encoding='utf-8') as fout:  # noqa
