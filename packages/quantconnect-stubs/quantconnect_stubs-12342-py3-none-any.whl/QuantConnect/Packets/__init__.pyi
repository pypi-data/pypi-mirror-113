...
class AlphaResultPacket(QuantConnect.Packets.Packet):
    ...
    @property
    def Portfolio(self) -> QuantConnect.Securities.SecurityPortfolioState:
        """The algorithms current portfolio state"""
        ...

    @Portfolio.setter
    def Portfolio(self, value: QuantConnect.Securities.SecurityPortfolioState):
        """The algorithms current portfolio state"""
        ...
