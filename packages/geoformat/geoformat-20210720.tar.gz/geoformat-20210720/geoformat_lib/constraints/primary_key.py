from geoformat_lib.conf.error_messages import non_unique_values
from geoformat_lib.conversion.feature_conversion import feature_deserialize
from geoformat_lib.conf.format_data import value_to_iterable_value
from geoformat_lib.conf.error_messages import missing_field
...
def create_pk(geolayer, pk_field_name):
    ...
    if field_exists:
        ...
        raise Exception(missing_field.format(field_name=pk_field_name))
