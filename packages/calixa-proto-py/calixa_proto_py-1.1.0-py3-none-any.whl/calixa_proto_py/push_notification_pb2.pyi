...
class Notification(google___protobuf___message___Message):
    ...
    maximum_notify_frequency_seconds: builtin___int = ...
    ...
    def __init__(self,
        *,
        ...
        maximum_notify_frequency_seconds : typing___Optional[builtin___int] = None,
        ) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"channel",b"channel",u"email",b"email",u"maximum_notify_frequency_seconds",b"maximum_notify_frequency_seconds",u"organization_id",b"organization_id",u"slack",b"slack",u"sms",b"sms",u"template",b"template",u"webhook",b"webhook"]) -> None: ...
