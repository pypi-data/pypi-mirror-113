...
class connect_util_Util:
    ...
    __slots__ = ()
    _hx_statics = ["replaceStrSensitiveData", "beautify", "beautifyObject", "maskFields", "maskParams", "maskParamsInObject", "maskParamsArray", "maskConfigParam", "isJson", "isJsonObject", "isJsonArray", "isArray", "isStruct", "createObjectDiff", "addIdsToObject", "compactArray", "getLines", "boolToInt", "toRegEx"]
    ...
    def beautify(text,compact,masked,beautify):
        try:
            ...
            None
            return connect_util_Util.replaceStrSensitiveData(text,connect_Env.getLogger()._getRegExMaskingList())
