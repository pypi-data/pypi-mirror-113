...
required to run a [Timelord](https://github.com/Chiadoge-Network/chiadogecoin/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chiadoge-Network/chiadogecoin/blob/main/install-timelord.sh)
