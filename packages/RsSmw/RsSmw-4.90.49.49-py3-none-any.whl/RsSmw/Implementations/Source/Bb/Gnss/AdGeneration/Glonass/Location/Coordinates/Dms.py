...
class Dms:
	...
	def set_pz(self, value: PzStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GLONass:LOCation:COORdinates:DMS:PZ \n
		Snippet: driver.source.bb.gnss.adGeneration.glonass.location.coordinates.dms.set_pz(value = PzStruct()) \n
		Sets the geographic reference location in degrees, minutes and seconds. \n
	...
	def set_wgs(self, value: WgsStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:ADGeneration:GLONass:LOCation:COORdinates:DMS:[WGS] \n
		Snippet: driver.source.bb.gnss.adGeneration.glonass.location.coordinates.dms.set_wgs(value = WgsStruct()) \n
		Sets the geographic reference location in degrees, minutes and seconds. \n
