...
class CLI:
    ...
    def flaprec(self, input_ff, out_path=None, model_path=None,
                show_intermediate=False, skip_preprocessing=False):
        ...
        :param model_path: Model filename. It will be looked-up in the
        workspace folder.
        :param show_intermediate: Use SimpleITK for showing intermediate
        :param skip_preprocessing: If the images in the folder are already
        preprocessed, set this flag to True.
        images.
        :return:
        """
        FlapReconstruction(input_ff, out_path, model_path,
