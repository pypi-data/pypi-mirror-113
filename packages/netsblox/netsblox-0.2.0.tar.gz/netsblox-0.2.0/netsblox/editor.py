...
class Pixabay:
    ...
    def __init__(self, client):
        self._client = client
    def search_photo(self, keywords, max_height=None, min_height=None):
        '''
        ...
        '''
        return self._client._call('Pixabay', 'searchPhoto', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
    def search_illustration(self, keywords, max_height=None, min_height=None):
        '''
        ...
        '''
        return self._client._call('Pixabay', 'searchIllustration', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
    def search_all(self, keywords, max_height=None, min_height=None):
        '''
        ...
        '''
        return self._client._call('Pixabay', 'searchAll', { 'keywords': keywords, 'maxHeight': max_height, 'minHeight': min_height })
...
class Thingspeak:
    ...
    def search_by_tag_and_location(self, tag, latitude, longitude, distance=None):
        '''
        Search for channels by tag and location.
        '''
        return self._client._call('Thingspeak', 'searchByTagAndLocation', { 'tag': tag, 'latitude': latitude, 'longitude': longitude, 'distance': distance })
