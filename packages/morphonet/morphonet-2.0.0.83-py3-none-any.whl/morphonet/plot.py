...
class Dataset():
    ...
    def _set_volume(self,data,t,factor=4):
        #Compute new Volumes
        inf=self.get_info('cell_volume',info_type="float")
        dataResize=data[::factor,::factor,::factor] #Computational Factor to reduce time computation
...
class Plot:#Main function to initalize the plot mode
    ...
    def __init__(self,log=True,start_browser=True,port_send=9875,port_recieve=9876,clear_backup=True,clear_temp=True):
        ...
        self.server_send.name="MorphoNet-Send-"+str(port_send)
        ...
        self.server_recieve.name="MorphoNet-Receive-"+str(port_recieve)
    ...
    def plot_mesh(self,t): #UPLOAD DITECLTY THE OBJ TIME POINT IN UNITY
        ...
        if data is not None:
            ...
            self.dataset._set_volume(data,t,factor=self.factor) #Update Volumes
