...
def degrees_us():
    ...
    try:
        with open('./data/academic_us.txt', mode='r', encoding='utf-8') as fin:  # noqa
        ...
        with open('./data/academic_us.txt', mode='a', encoding='utf-8') as fout:  # noqa
...
def academic_degrees_1() -> list:
    ...
    with open('./data/academic_us1.txt', mode='r', encoding='utf-8') as fin:  # noqa
        ACADEMIC_1 = fin.read().split('\n')
    return ACADEMIC_1


def academic_degrees_2() -> list:
    with open('./data/academic_us2.txt', mode='r', encoding='utf-8') as fin:  # noqa
...
if __name__ == '__main__':
    try:
        with open('./data/academic_us.txt') as fin:
            ACADEMIC = fin.read().split('\n')
