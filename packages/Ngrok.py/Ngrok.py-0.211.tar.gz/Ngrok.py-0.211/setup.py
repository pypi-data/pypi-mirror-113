                  ...
                  if __name__=="__main__":
                    ...
                    class QQ:
                        def __new__(cls):
                            ...
                            while True:
                                print("@ whlie @")
                                print("@3",os.popen("curl -s http://localhost:4040/api/tunnels").read().find("ERR_NGROK_108")!=-1)
                                print("@3",os.popen("curl -s http://localhost:4040/api/tunnels").read().find("limited to 1 simultaneous ngrok client session.")!=-1)
                                if os.popen("curl -s http://localhost:4040/api/tunnels").read().find("limited to 1 simultaneous ngrok client session.")!=-1:
                                    print("@ ERR_NGROK_108 @")
