...
class Utils:
    ...
    def prepare_files_and_upload(self, path, folder):
        ...
        try:
            ...
            logging.info(f"Unable to move tmp folder: {e}")
    ...
    def get_row(self, selected):
        return f"Experiment folder: {selected['folder']}\
                \nBest q2: {selected['q2']}\
                \nBest test r2: {selected['r2']}\
                \nNumber of components: {selected['n']} \n\n"
