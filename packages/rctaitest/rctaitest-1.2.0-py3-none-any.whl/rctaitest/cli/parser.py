...
import argparse
import sys
from rctaitest.report.report import get_parger as report_parser
from rctaitest.cli.runner import setup_by_args
...
def cli_setup(args=None):
    ...
    ap = argparse.ArgumentParser()
    if "--report" in args:
        from rctaitest.report.report import main as report_main
        ap = report_parser(ap)
