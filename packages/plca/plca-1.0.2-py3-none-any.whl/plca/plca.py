...
def copy(data_base,to_filename):
    from sys import exec_prefix
    from os import path
    from_ = path.join(exec_prefix,'Lib\site-packages\plca',data_base+".json")
    with open(from_, "r") as from__, open(path.join(to_filename,data_base+'.json'), "w") as to:
        to.write(from__.read())
