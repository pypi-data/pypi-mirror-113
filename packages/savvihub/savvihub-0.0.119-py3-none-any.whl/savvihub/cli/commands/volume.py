...
def volume_file_list(ctx: Context, volume_id: int, dataset_version: str, path: str, recursive: bool, directory: bool):
    ...
    if recursive and directory:
        ...
        file = client.volume_file_read(volume_id, path, dataset_version)
...
def volume_file_copy_remote_to_remote(
    ...
    source_file = client.volume_file_read(source_volume_id, source_path, source_dataset_version)
...
def volume_file_copy_local_to_remote(
    ...
    try:
        dest_file = client.volume_file_read(dest_volume_id, dest_path, dest_dataset_version)
    except NoSuchFileOrDirectoryAPIException:
        dest_file = None
