...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.11.0-alpha.1626444966+2c8b9a54'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.11.0-alpha.1626444966+2c8b9a54`
                """)
            else:
                raise
