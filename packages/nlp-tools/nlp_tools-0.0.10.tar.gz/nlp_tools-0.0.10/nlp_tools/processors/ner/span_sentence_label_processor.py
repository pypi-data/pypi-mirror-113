...
from nlp_tools.utils.ner_utils import span_extract_item,span_extract_item_no_push
...
class SpanSentenceLabelProcessor(ABCLabelProcessor):
    ...
    def __init__(self,return_one_hot=True,
                 **kwargs: Any) -> None:
        """
    ...
    def inverse_transform(self,
        ...
        for index, (labels_start,labels_end, sequece_length) in enumerate(zip(labels[0],labels[1], lengths)):
            ...
            entities = span_extract_item_no_push(labels_start,labels_end)
