    ...
    """
{
    ...
    "package_data": {
        "cdk_stepfunctions_redshift._jsii": [
            "cdk-stepfunctions-redshift@1.100.1.jsii.tgz"
        ],
        "cdk_stepfunctions_redshift": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-lambda-python==1.100.0",
        ...
        "aws-solutions-constructs.aws-events-rule-sqs==1.100.0",
        "aws-solutions-constructs.aws-lambda-dynamodb==1.100.0",
        "aws-solutions-constructs.aws-sqs-lambda==1.100.0",
