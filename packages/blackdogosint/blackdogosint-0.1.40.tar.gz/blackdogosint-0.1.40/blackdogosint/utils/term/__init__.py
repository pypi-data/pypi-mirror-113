...
from blackdogosint.utils.term import key
from blackdogosint.utils.term import keymap
from blackdogosint.utils.term import readline
from blackdogosint.utils.term import term
from blackdogosint.utils.term import termcap
from blackdogosint.utils.term import text
...
def can_init():
    ...
    Iff this function returns `True`, a call to :meth:`init` will let
...
def init():
    ...
    It is on our TODO, to create a function to "give back" the terminal
