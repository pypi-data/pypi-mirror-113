    ...
    def __init__(self, config, section=None):
        ...
        self.requiredvars = {
            'path_template': {
                ...
                'descritption': 'template string where to place uris of a certain category'
            },
            
            'urltype_map_file': {
                'default': '/etc/fuglu/uriwriter_urltypes.txt',
