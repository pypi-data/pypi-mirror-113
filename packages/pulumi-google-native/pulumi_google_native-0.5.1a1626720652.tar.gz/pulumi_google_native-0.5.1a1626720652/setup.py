...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'google-native', '0.5.1a1626720652'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource google-native 0.5.1a1626720652`
                """)
            else:
                raise
