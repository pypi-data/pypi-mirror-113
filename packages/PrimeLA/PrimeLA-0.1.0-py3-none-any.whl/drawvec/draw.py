...
def draw_vectors(vector_list, start = (0,0,0), color_list = [], figsize=(10,10), linked=False, axis=None, elevation = None, azimuth = None) :
...
def draw_matrix(mat, figsize=(10, 10), axis = None, elevation = None, azimuth=None):
    cols = mat.shape[1]
    color = ['r', 'g', 'b' ]
    vectors = []
    colors = []
...
def draw_points(mat, figsize=(10, 10), color='k', ls='-', axis=None, elevation=None, azimuth=None):
