...
def wizzi_utils_requirements():
    ...
    print(LINES)
    url_cuda_90 = 'https://download.pytorch.org/whl/cu90/torch_stable.html'

    print(pack.format(TT_PACK, TT_MOD, TT_SC))
    print('\ttorch options:')
    print('\t\t{} # cpu'.format(pip.format('torch')))
    print('\t\t{} # gpu(cuda 9\9.1)'.format(pip.format('torch==1.1.0 torchvision==0.3.0 -f {}'.format(url_cuda_90))))
    url_cuda = 'https://download.pytorch.org/whl/torch_stable.html'
    cuda114 = pip.format('torch==1.9.0+cu111 torchvision==0.10.0+cu111 torchaudio===0.9.0 -f {}'.format(url_cuda))
    print('\t\t{} # gpu(cuda 11.4)'.format(cuda114))
    ...
    print('\t\t{} # windows 10'.format(pip.format('--index-url {} tflite_runtime'.format(url))))
