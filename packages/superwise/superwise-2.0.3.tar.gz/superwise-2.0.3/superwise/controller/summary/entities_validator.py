...
class EntitiesValidator:
    def __init__(self, task, version_entities_df, MAX_DIMENSIONS=None):
        """
            version_entities_df
    ...
    def _boolean_types_valid(self):
        ...
        for boolean_column in boolean_columns:
            ...
            self._data[boolean_column] = self._data[boolean_column].map({0: False, 1: True, False: False, True: True})
