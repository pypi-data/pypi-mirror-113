...
[boto3.ApplicationDiscoveryService 1.18.5](https://boto3.amazonaws.com/v1/documentation/api/1.18.5/reference/services/discovery.html#ApplicationDiscoveryService)
