...
def begin(local, file):
    if local:
        ...
        try:
            ...
            container = client.create_container(name='rio-api', image='chainopt/rio-api:' + version,
                                                stdin_open=True,
                                                tty=True,
...
def login(file: str):
    ...
    # Instantiate the default credentials path
    ...
    if file:
        ...
        try:
            return cred_check(docker_creds, cred_path, client)
        except requests.exceptions.HTTPError:
...
def cred_check(docker_creds, cred_path, client):
    ...
    with open(cred_path, 'w') as f:
        ...
        click.echo("Credentials have been saved!")
        f.close()
