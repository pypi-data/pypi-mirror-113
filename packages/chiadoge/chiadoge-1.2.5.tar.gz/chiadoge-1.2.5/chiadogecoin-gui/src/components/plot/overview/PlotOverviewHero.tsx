...
import { CardHero, Flex, Link } from '@chiadoge/core';
import { PlotHero as PlotHeroIcon } from '@chiadoge/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Chiadoge. '
              }
              <Link
                target="_blank"
                href="https://github.com/Chiadoge-Network/chiadogecoin/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
