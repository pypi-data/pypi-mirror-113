...
class Date:
	...
	def set(self, structure: DateStruct, satelliteSvid=repcap.SatelliteSvid.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.sbas.simulated.clock.date.set(value = [PROPERTY_STRUCT_NAME](), satelliteSvid = repcap.SatelliteSvid.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:GNSS:SVID{satelliteSvid_cmd_val}:SBAS:SIMulated:CLOCk:DATE', structure)
