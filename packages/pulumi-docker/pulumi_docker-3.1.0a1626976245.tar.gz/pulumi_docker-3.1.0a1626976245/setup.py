...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '3.1.0-alpha.1626976245+2073e8aa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 3.1.0-alpha.1626976245+2073e8aa`
                """)
            else:
                raise
