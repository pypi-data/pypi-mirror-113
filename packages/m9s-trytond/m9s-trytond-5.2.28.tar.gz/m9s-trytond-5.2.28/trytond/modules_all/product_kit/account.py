...
#    __name__ = 'account.invoice'
    ...
    ## update_unit_price was added with 5.8 and is too expensive to backport
    ## we tolerate a possible inaccurate cost price in the case of differing
    ## prices between order and invoice
    #@classmethod
    #@ModelView.button
