...
class Objeto():
    ...
    def borda_superior(self):
        ...
        borda_superior.width -= 2 * self.largura_da_borda
        borda_superior.left = self.esquerda + self.largura_da_borda
    ...
    def borda_inferior(self):
        ...
        borda_inferior.width -= 2 * self.largura_da_borda
        borda_inferior.left = self.esquerda + self.largura_da_borda
    ...
    def borda_esquerda(self):
        ...
        borda_esquerda.height -= 2 * self.largura_da_borda
        borda_esquerda.top = self.topo + self.largura_da_borda
    ...
    def borda_direita(self):
        ...
        borda_direita.height -= 2 * self.largura_da_borda
        borda_direita.top = self.topo + self.largura_da_borda
...
class Tela():
    def __init__(self, largura, altura, cor, fps):
        ...
        self.cor = cor
        self.fps = fps
        self._tela = pygame.display.set_mode( [self.largura, self.altura] ) 
...
def atualizar_tela(largura, altura, cor, fps):
    global rodar_threading
