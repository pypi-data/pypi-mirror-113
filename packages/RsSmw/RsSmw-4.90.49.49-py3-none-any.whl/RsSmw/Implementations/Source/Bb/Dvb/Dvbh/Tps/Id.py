...
class Id:
	...
	def get_pattern(self) -> PatternStruct:
		...
		Snippet: value: PatternStruct = driver.source.bb.dvb.dvbh.tps.id.get_pattern() \n
		Sets the pattern for cell identification. \n
			:return: structure: for return value, see the help for PatternStruct structure arguments.
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:BB:DVB:DVBH:TPS:ID:PATTern?', self.__class__.PatternStruct())

	def set_pattern(self, value: PatternStruct) -> None:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBH:TPS:ID:PATTern \n
		Snippet: driver.source.bb.dvb.dvbh.tps.id.set_pattern(value = PatternStruct()) \n
		Sets the pattern for cell identification. \n
			:param value: see the help for PatternStruct structure arguments.
		"""
		self._core.io.write_struct('SOURce<HwInstance>:BB:DVB:DVBH:TPS:ID:PATTern', value)
