...
requirements = ["requests<=2.21.0", "datetime<=4.2"]
...
setuptools.setup(
	...
	author="kirillsaint",
	# Его почта.
	author_email="kirillsaint@wtfuck.tk",
	# Краткое описание, которое будет показано на странице PyPi.
	description="Can search for information about releases on UPC and ISRC",
