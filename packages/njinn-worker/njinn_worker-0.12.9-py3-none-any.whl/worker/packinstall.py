...
class PackInstallation:
    def __init__(self, pack_identifier, njinn_api, base_path=None):
        ...
        self.base_path = get_working_dir() if base_path is None else base_path
    ...
    def setup(self):
        ...
        with change_working_directory(self.base_path), FileLock(self.lock_name):
            log.debug(
