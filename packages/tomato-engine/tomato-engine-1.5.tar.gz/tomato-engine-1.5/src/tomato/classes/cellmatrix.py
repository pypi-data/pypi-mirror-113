...
class CellMatrix:
    # {{{
    def __init__(self, state_matrix, rule_module, cell_args=None):
        # {{{
        """
    ...
    @classmethod
    def from_display(cls, display_matrix, rule_module, cell_args=None):
        # {{{
        """
        ...
        return cls(state_matrix, rule_module, cell_args)
