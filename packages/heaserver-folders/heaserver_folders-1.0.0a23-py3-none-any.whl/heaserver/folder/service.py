...
@action(name='heaserver-folders-folder-open', path='/folders/{id}/opener', rel='opener')
@action(name='heaserver-folders-folder-get-properties', rel='properties')
@action(name='heaserver-folders-folder-duplicate', rel='duplicator', path='/folders/{id}/duplicator')
...
@routes.get('/folders/{folder_id}/items/')
@action(name='heaserver-folders-item-new', path='/folders/{folder_id}/newitem', include_root=True)
