...
exports.tokenizeSearch = exports.QueryResults = exports.TokenType = void 0;
...
var QueryResults = /** @class */ (function () {
    ...
    QueryResults.prototype.addStringTag = function (value, shouldEscape) {
        ...
        var _a = tslib_1.__read(formatTag(value), 2), key = _a[0], tag = _a[1];
    ...
    QueryResults.prototype.addTagValues = function (tag, tagValues, shouldEscape) {
        ...
        if (shouldEscape === void 0) { shouldEscape = true; }
        try {
            for (var tagValues_1 = tslib_1.__values(tagValues), tagValues_1_1 = tagValues_1.next(); !tagValues_1_1.done; tagValues_1_1 = tagValues_1.next()) {
                ...
                this.tagValues[tag] = Array.isArray(this.tagValues[tag])
                    ? tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.tagValues[tag])), [escaped]) : [escaped];
    ...
    QueryResults.prototype.copy = function () {
        ...
        q.tagValues = tslib_1.__assign({}, this.tagValues);
