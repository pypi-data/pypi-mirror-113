...
class InstallPluginCommand(install):
    def run(self):
        ...
        try:
            check_call(
                [                    'pulumi', 'plugin', 'install', 'resource', 'databricks', '0.0.1', '--server',
            'https://github.com/ingenii-solutions/pulumi-databricks/releases/download/v0.0.1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource databricks 0.3.6`
                """)
            else:
                raise
