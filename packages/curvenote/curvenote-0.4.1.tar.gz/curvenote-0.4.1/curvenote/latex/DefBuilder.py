from curvenote.latex.schema.SchemaOptionDefs import CustomTemplateDefs, SchemaOptionDefs
import os
import logging
...
class DefBuilder:
    ...
    def _resolve_options(self, template_options: TemplateOptions) -> List[Union[SchemaOptionDefs, CustomTemplateDefs]]:
        ...
        for name, schema_option in self.schema_options.items():
            ...
            if template_options.schema and name in template_options.schema:
    ...
    def compose(self, template_options: TemplateOptions):
        ...
        for name, _ in template_options.schema.items():
    ...
    def get_content_transforms(self, template_options: TemplateOptions) -> List[Callable[[str], str]]:
        list_of_defs = self._resolve_options(template_options)
