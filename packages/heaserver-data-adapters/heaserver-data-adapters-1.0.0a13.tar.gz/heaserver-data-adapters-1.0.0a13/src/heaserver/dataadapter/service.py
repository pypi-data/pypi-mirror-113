...
@action('heaserver-data-adapters-data-adapter-duplicate', rel='duplicator')
...
@action(name='heaserver-data-adapters-data-adapter-duplicate-form', path='/dataadapters/{id}')
...
@routes.post('/dataadapters/duplicator')
