...
var OrganizationAuditLog = /** @class */ (function (_super) {
    ...
    OrganizationAuditLog.prototype.renderBody = function () {
        ...
        return (<auditLogList_1.default entries={this.state.entryList} pageLinks={this.state.pageLinks} eventType={currentEventType} eventTypes={EVENT_TYPES} onEventSelect={this.handleEventSelect} {...this.props}/>);
    };
