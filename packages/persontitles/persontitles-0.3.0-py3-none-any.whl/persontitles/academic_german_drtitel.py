...
def degrees_ger_drtitel() -> list:
    try:
        with open('./src/persontitles/academic_german_drtitel.txt', mode='r', encoding='utf-8') as fin:  # noqa
            DEGREES_DRTITEL = fin.read().split('\n')
    except FileNotFoundError:
        DEGREES_DRTITEL = dr_degrees()
        with open('./src/persontitles/academic_german_drtitel.txt', mode='a', encoding='utf-8') as fout:  # noqa
