class MainRouter(object):
    ...
    def allow_syncdb(self, db, model):
        ...
        if model._meta.app_label == 'metadatos' or 'METADATOS' in db:
            ...
            return False
        elif db == 'default' and model._meta.app_label == 'general':
            return False
        else:
            return True
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        """
        #print(app_label)
        if app_label == 'config' or 'CONFIG' in db:
            return False
        if app_label == 'metadatos' or 'METADATOS' in db:
            return False
        elif app_label == 'auth' and db != 'default':
            return False
        elif app_label == 'django' and db != 'default':
            return False
        elif db == 'default' and app_label == 'models_base':
            return False
        elif db == 'default' and app_label == 'general':
            return False
        else:
            return True
