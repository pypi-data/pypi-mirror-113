...
import re
import six
from rctaitest.core.android.yosemite import Yosemite
from rctaitest.core.android.constant import YOSEMITE_PACKAGE
...
from rctaitest.utils.snippet import on_method_ready
...
class Recorder(Yosemite):
    ...
    def start_recording(self, max_time=1800, bit_rate=None):
        ...
        if getattr(self, "recording_proc", None):
            raise rctaitestError("recording_proc has already started")
    ...
    def stop_recording(self, output="screen.mp4", is_interrupted=False):
        ...
        Raises:
            rctaitestError: if recording was not started before
        ...
        for line in p.stdout.readlines():
            ...
            if m:
                ...
                return True
        raise rctaitestError("start_recording first")
