...
def _align_long_reads_fastq(long_reads_fastq_path, reference_sequence_input, output_directory, threads, quiet = False, silent = False):
    """
        ...
        if combined_long_read_fastq_path:
            ...
            sorted_bam_file_paths.append(
                _align_long_reads_fastq(
                    combined_long_read_fastq_path, reference_sequence_input, self.output_directory, self.max_threads, quiet = quiet, silent = silent
                )
            )
