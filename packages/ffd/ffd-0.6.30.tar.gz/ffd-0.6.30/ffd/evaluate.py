...
DATA_DIR = '/tmp/project/data/datasets'
...
class RecordResult(object):
    def __init__(self, fpr=None, tpr=None, auc=-np.inf, dataset=None, loss_file=None, labels=None, scores=None):
        self.fpr = fpr
        self.tpr = tpr
        self.auc = auc
...
def compute_auc(loss_file):
    ...
    for sub_loss_file in loss_file_list:
        ...
        results = RecordResult(fpr, tpr, auc, dataset, sub_loss_file, labels, scores)
