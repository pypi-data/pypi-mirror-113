...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.5.0-alpha.1626779205+0f960ebe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.5.0-alpha.1626779205+0f960ebe`
                """)
            else:
                raise
