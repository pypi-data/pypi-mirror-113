...
class AwsSsmSecretProvider(SecretProvider):
    ...
    def add(self, project, application, stage, key, value):
        ...
        response = self.ssm.put_parameter(Name=path, Value=encode_nulls(value), Type='SecureString', Overwrite=True)
        return {
                'Key': key, 
                'Value': value,
    ...
    def get(self, project, application, stage, key, revision=None, decrypt=False):
        ...
        response = self.ssm.get_parameter_history(Name=found['Name'], WithDecryption=decrypt)
    ...
    def delete(self, project, application, stage, key):
        ...
        self.ssm.delete_parameter(Name=found['Name'])
        return {
                'Key': key, 
                'Scope': found['Scope'],
                'Origin': found['Origin'],
