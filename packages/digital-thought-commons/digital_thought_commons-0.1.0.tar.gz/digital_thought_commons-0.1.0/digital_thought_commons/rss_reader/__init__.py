...
for url in ['https://krebsonsecurity.com/feed/', 'https://cafedread.com/d/malware/rss',
            'https://cafedread.com/d/DarkNetMarkets/rss', 'https://cafedread.com/d/hacking/rss',
            'https://cafedread.com/d/fraud/rss', 'https://cafedread.com/d/DarkNetAustralia/rss',
            'https://cafedread.com/d/OpSec/rss', 'https://cafedread.com/d/programming/rss',
            'https://cafedread.com/d/Monero/rss', 'https://www.darkreading.com/rss_simple.asp',
            'https://threatpost.com/feed/', 'https://raidforums.com/syndication.php?limit=100',
            'https://blog.malwarebytes.com/feed/', 'https://feeds.feedburner.com/TheHackersNews',
            'https://www.hackerone.com/blog.rss', 'https://latesthackingnews.com/feed/',
            'https://www.welivesecurity.com/feed/', 'https://www.zerodayinitiative.com/rss/published/',
            'https://www.zerodayinitiative.com/rss/upcoming/', 'https://www.zerodayinitiative.com/blog/?format=rss',
            'https://www.kaspersky.com/blog/feed/', 'https://securelist.com/feed/',
            'https://tools.cisco.com/security/center/psirtrss20/CiscoSecurityAdvisory.xml',
            'https://us-cert.cisa.gov/ics/alerts/alerts.xml', 'https://us-cert.cisa.gov/ics/advisories/advisories.xml',
            'https://us-cert.cisa.gov/ics/announcements/announcements.xml',
            'https://www.cshub.com/rss/categories/attacks', 'https://www.cshub.com/rss/categories/malware',
            'https://www.cshub.com/rss/articles', 'https://www.carbonblack.com/feed/']:
    read(url)
