...
def codetranslate(code):
    ...
    codedict=pd.DataFrame([
        ...
        # 新加入
        ["600030.SS",'Citic Securities'],["601519.SS",'Great Wisdom'],
        ["601995.SS",'CICC'],["601788.SS",'Everbright Securities'],
        ["300059.SZ",'East Money Info'],["601878.SS",'Zheshang Securities'],
