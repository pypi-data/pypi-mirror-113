...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'random', '4.3.0-alpha.1626302928+90bb448e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource random 4.3.0-alpha.1626302928+90bb448e`
                """)
            else:
                raise
